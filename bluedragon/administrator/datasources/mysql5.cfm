...
<cfsavecontent variable="request.content">
  <cfoutput>
	...
	<tr>
	  <td bgcolor="##f0f0f0" style="width:200px;">OpenBD Datasource Name</td>
	  <td>
	...
	<tr>
	  ...
	  <td>
	    <input name="password" id="password" type="password" class="span6" value="#dsinfo.password#" tabindex="6" />
	  </td>
	</tr>
	<tr>
	  <td valign="top" bgcolor="##f0f0f0">Description</td>
	  <td valign="top">
	    <textarea name="description" id="description" class="span6" rows="4" tabindex="7"><cfif StructKeyExists(dsinfo, "description")>#dsinfo.description#</cfif></textarea>
	  </td>
	</tr>
	<tr bgcolor="##dedede">
	  <td>
	...
	<table>
	  ...
	  <tr>
	    <td bgcolor="##f0f0f0">Cache Result Set Metadata</td>
	    <td>
	      <input type="checkbox" name="cacheresultsetmetadata" id="cacheresultsetmetadata" value="true" 
		     <cfif dsinfo.cacheresultsetmetadata> checked="true"</cfif> tabindex="19" />
	    </td>
	  </tr>
	  <tr>
	    ...
	    <td>
	      <input type="text" name="maxconnections" id="maxconnections" class="span2" maxlength="4" 
		     value="#dsinfo.maxconnections#" tabindex="20" />
	    </td>
	  </tr>
	  <tr>
	    ...
	    <td>
	      <input type="text" name="connectiontimeout" id="connectiontimeout" class="span2" maxlength="10" 
		     value="#dsinfo.connectiontimeout#" tabindex="21" />
	    </td>
	  </tr>
	  <tr>
	    ...
	    <td>
	      <input type="text" name="logintimeout" id="logintimeout" class="span2" maxlength="4" 
		     value="#dsinfo.logintimeout#" tabindex="22" />
	    </td>
	  </tr>
	  <tr>
	    <td bgcolor="##f0f0f0">Connection Retries</td>
	    <td>
	      <input type="text" name="connectionretries" id="connectionretries" span="2" maxlength="4" 
		     value="#dsinfo.connectionretries#" tabindex="23" />
	    </td>
	  </tr>
	</table>
      </div>
