...
<cfsilent>
  ...
  <cfif !StructKeyExists(dsinfo, "initstring")>
    <cfset dsinfo.initstring = "" />
  </cfif>
  
  <cfif !StructKeyExists(dsinfo, "perrequestconnections")>
    <cfset dsinfo.perrequestconnections = false />
  </cfif>
  
  <cfif !StructKeyExists(dsinfo, "connectionretries")>
  ...
  <cfif !StructKeyExists(dsinfo, "connectstring")>
    ...
    <cfelseif StructKeyExists(dsinfo, "connectstring") && dsinfo.connectstring != "">
...
<cfsavecontent variable="request.content">
  <cfoutput>
	...
	<tr>
	  <td valign="top" bgcolor="##f0f0f0">JDBC URL</td>
	  <td valign="top">
	    <textarea name="hoststring" id="hoststring" class="span6" rows="4" tabindex="2">#dsinfo.hoststring#</textarea>
	  </td>
	</tr>
	<tr>
	  <td bgcolor="##f0f0f0">Driver Class</td>
	  <td>
	    <input name="drivername" id="drivername" type="text" class="span6" maxlength="250" value="#dsinfo.drivername#" 
		   tabindex="3" />
	  </td>
	</tr>
	<tr>
	  ...
	  <td>
	    <input name="username" id="username" type="text" class="span6" maxlength="50" value="#dsinfo.username#" tabindex="4" />
	  </td>
	</tr>
	<tr>
	  <td bgcolor="##f0f0f0">Password</td>
	  <td>
	    <input name="password" id="password" type="password" class="span6" value="#dsinfo.password#" 
		   tabindex="5" />
	  </td>
	</tr>
	<tr>
	  ...
	  <td valign="top">
	    <textarea name="description" id="description" rows="4" class="span6" tabindex="6"><cfif StructKeyExists(dsinfo, "description")>#dsinfo.description#</cfif></textarea>
	  </td>
	</tr>
	<tr>
	  <td valign="top" bgcolor="##f0f0f0">Verification Query</td>
	  <td valign="top">
	    <textarea name="verificationquery" id="verificationquery" rows="4" class="span6" tabindex="7"><cfif StructKeyExists(dsinfo, "verificationquery")>#dsinfo.verificationquery#</cfif></textarea>
	  </td>
	</tr>
	<tr bgcolor="##dedede">
	  <td>
	  ...
	  <td align="right">
	    ...
	    <input type="button" class="btn default" name="cancel" value="Cancel" onclick="javascript:location.replace('index.cfm');" 
		   tabindex="10" />
	  </td>
	</tr>
      </table>
	...
	<table>
	  ...
	  <tr>
	    ...
	    <td valign="top">
	      <textarea name="connectstring" id="connectstring" rows="4" class="span6" tabindex="11">#dsinfo.connectstring#</textarea><br />
	      <em>
