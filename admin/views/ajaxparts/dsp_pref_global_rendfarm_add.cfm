...
<div id="rfstab">
	<ul>
		<li><a href="##serversetup">#myFusebox.getApplicationData().defaults.trans("header_server_setup")#</a></li>
	...
	<div id="serversetup">
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="grid">
			<!--- Enable Server --->
			<tr>
				<th colspan="2">#myFusebox.getApplicationData().defaults.trans("header_server_enable")#</th>
			</tr>
			<tr>
				<td colspan="2"><input type="radio" name="rfs_active" id="rfs_active" value="true"<cfif qry_rfs.rfs_active EQ true> checked="checked"</cfif>> #myFusebox.getApplicationData().defaults.trans("yes")# <input type="radio" name="rfs_active" id="rfs_active" value="false"<cfif qry_rfs.rfs_active EQ false OR qry_rfs.recordcount EQ 0> checked="checked"</cfif>> #myFusebox.getApplicationData().defaults.trans("no")#</td>
			</tr>
			<!--- Server Name --->
			<tr>
				<th colspan="2">#myFusebox.getApplicationData().defaults.trans("header_server_name")#</th>
			</tr>
			<tr>
				<td colspan="2">#myFusebox.getApplicationData().defaults.trans("header_server_name_desc")#</td>
			</tr>
			<tr>
				<td colspan="2"><input type="text" name="rfs_server_name" id="rfs_server_name" style="width:300px;" value="#qry_rfs.rfs_server_name#" /> <input type="button" class="button" value="#myFusebox.getApplicationData().defaults.trans("validate")#" onclick="valserver();" /><div id="div_valserver" style="display:none;"></div></td>
			</tr>
			<!--- Server Location --->
			<tr>
				<th colspan="2">#myFusebox.getApplicationData().defaults.trans("header_location")#</th>
			</tr>
			<tr>
				<td colspan="2">#myFusebox.getApplicationData().defaults.trans("header_location_desc")#</td>
			</tr>
			<tr>
	...
	<div id="servertools">
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="grid">
			...
			<tr>
				<td nowrap="nowrap">#myFusebox.getApplicationData().defaults.trans("imagemagick_path")#</td>
			...
			<!--- DCRAW Paths --->
			<tr>
				<th class="textbold" colspan="2">#myFusebox.getApplicationData().defaults.trans("header_dcraw")#</th>
			</tr>
			<tr>
			...
			<!--- MP4Box Paths --->
			<tr>
				<th class="textbold" colspan="2">#myFusebox.getApplicationData().defaults.trans("header_mp4box")#</th>
			</tr>
			<tr>
...
--->
	<div id="submit" style="float:right;padding:10px;"><div id="updatetext" style="color:green;padding:10px;display:none;float:left;"></div><input type="submit" name="Submit" value="#myFusebox.getApplicationData().defaults.trans("save")#" class="button"></div>
</div>
</form>
...
<script type="text/javascript">
	...
	function rfs_feedback() {
		...
		$('##updatetext').html('#myFusebox.getApplicationData().defaults.trans("success")#');
		$('##rfs_add').val('false');
