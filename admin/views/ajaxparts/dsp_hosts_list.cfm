...
<table width="600" border="0" cellspacing="0" cellpadding="0" class="grid">
	<tr>
		...
		<td nowrap="nowrap"><cfif application.razuna.isp><a href="http://#cgi.http_host##dynpath#/raz1/dam/index.cfm?v=#createuuid()#&fusebox.loadclean=true&fusebox.password=#application.fusebox.password#&fusebox.parseall=true" target="_blank">Reset Cache</a></cfif></td>
	</tr>
	<!--- Next and Back --->
	<tr>
