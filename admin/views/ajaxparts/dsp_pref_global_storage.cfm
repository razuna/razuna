...
<cfoutput>
	<table width="700" border="0" cellspacing="0" cellpadding="0" class="grid">
		...
		<tr>
			...
			<tr>
				<td align="center"><input type="radio" name="conf_storage" value="local"<cfif gprefs.conf_storage EQ "local"> checked</cfif>></td>
			...
			<tr>
				<td align="center"><input type="radio" name="conf_storage" value="nirvanix"<cfif gprefs.conf_storage EQ "nirvanix"> checked</cfif>></td>
			...
			<tr>
				<td align="center"><input type="radio" name="conf_storage" value="amazon"<cfif gprefs.conf_storage EQ "amazon"> checked</cfif>></td>
