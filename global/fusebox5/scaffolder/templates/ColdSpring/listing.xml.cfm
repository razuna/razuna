...
<<cfoutput>>	
	<fuseaction name="$$objectName$$_Listing" access="public">
		...
		<set name="attributes.totalRowCount" value="#variables.$$objectName$$Service.getRecordCount()#" />
		...
		<set name="q$$objectName$$" value="#variables.$$objectName$$Service.get$$objectName$$s(sortByFieldList=attributes._listSortByFieldList,startrow=attributes._startRow,maxrows=attributes._maxrows)#" />
