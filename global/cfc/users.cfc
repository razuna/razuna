...
<cffunction name="emailinfo" output="true">
	...
	<!--- The message --->
	<cfsavecontent variable="m"><cfoutput>Hi,<br /><br />#user_login_info_email_content#<br /><br />Login: #session.thehttp##cgi.http_host##cgi.script_name#<br />Username: #qry_user.user_login_name#<cfif arguments.userpass NEQ ""><br />Password: #arguments.userpass#</cfif><br /><br />#login_info_email_contactus#</cfoutput>
	</cfsavecontent>
	<!--- Send the email --->
