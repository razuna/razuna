...
<cffunction name="emailinfo" output="true">
	...
	<!--- The message --->
	<cfsavecontent variable="m"><cfoutput>Hi,<br /><br />Your Razuna account login information are as follows:<br /><br />Login: http://#cgi.http_host##cgi.script_name#<br />Username: #qry_user.user_email#<cfif arguments.userpass NEQ ""><br />Password: #arguments.userpass#</cfif><br /><br />Please feel free to contact us if you have any questions.</cfoutput>
	</cfsavecontent>
	<!--- Send the email --->
