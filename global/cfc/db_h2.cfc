	...
	<cffunction name="setup" access="public" output="false">
		...
		<cfif NOT structkeyexists(arguments.thestruct,"fromimport")>
			...
			<cfinvoke method="BDsetDatasource">
				...
				<cfinvokeargument name="hoststring" value="jdbc:h2:#arguments.thestruct.pathoneup#db/razuna;IGNORECASE=TRUE;MODE=Oracle;AUTO_RECONNECT=TRUE;LOG=0;CACHE_SIZE=300000;CACHE_TYPE=SOFT_LRU;AUTO_SERVER=TRUE" />
