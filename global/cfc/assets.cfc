...
Razuna has converted your asset (#arguments.thestruct.emailorgname#) to the format #ucase(arguments.thestruct.convert_to)# on #dateformat(now(),"#thedateformat#")# at #timeformat(now(),"HH:mm:sstt")#.">
		...
		<!--- Send the email --->
		<cftry>
			<cfinvoke component="email" method="send_email" dsn="#arguments.thestruct.dsn#" setid="#arguments.thestruct.setid#" to="#qryuser.user_email#" subject="#thesubject#" themessage="#mailmessage#">
		<cfcatch type="any">
			<cfinvoke component="debugme" method="email_dump" emailto="support@razuna.com" emailfrom="server@razuna.com" emailsubject="debug" dump="#cfcatch#">
		</cfcatch>
		</cftry>
...
<cffunction name="addasset" output="true">
	...
	<!---
	<cfinvoke method="addassetthread" thestruct="#arguments.thestruct#" returnvariable="arguments.thestruct.qryfile.path" />
	...
	<!---
<cfthread action="join" name="#tt#" />
	<cfmail to="nitai@razuna.com" from="server@razuna.com" subject="debug addasset" type="html">
		#cfthread["#tt#"].status#
	</cfmail>
--->
	<!--- Return --->
	<!--- <cfreturn #cfthread["#tt#"].output#> --->
	<cfreturn arguments.thestruct.qryfile.path>
</cffunction>
...
<cffunction name="removeasset" output="true">
	...
	<cfthread name="#tt#" intvars="#ts#">
		...
		<!--- Select temp assets which are older then 3 hours --->
				...
				<cftry>
					...
					<cfif attributes.intstruct.qryfile.extension EQ "PDF" AND attributes.intstruct.qryfile.link_kind NEQ "url">
						...
						<cfif attributes.intstruct.qryfile.link_kind EQ "lan">
							...
							<cfset attributes.intstruct.thetempdirectory = "#attributes.intstruct.thepath#/incoming/asset#createuuid()#">
						...
						<cfif attributes.intstruct.iswindows>
							...
							<!--- Execute --->
							<cfexecute name="#attributes.intstruct.theimconvert#" arguments="#attributes.intstruct.theorgfileflat# -thumbnail 128x -strip -colorspace RGB #attributes.intstruct.thetempdirectory#/#attributes.intstruct.thepdfimage#" timeout="60" />
							<cfif attributes.intstruct.storage NEQ "amazon">
								<cfexecute name="#attributes.intstruct.theimconvert#" arguments="#attributes.intstruct.theorgfile# #attributes.intstruct.thetempdirectory#/razuna_pdf_images/#attributes.intstruct.thepdfimage#" timeout="60" />
							</cfif>
					...
					<cfelse>
						...
						<cfif attributes.intstruct.iswindows>
							<cfset attributes.intstruct.theexif = """#attributes.intstruct.thetools.exiftool#/exiftool.exe""">
							<cfexecute name="#attributes.intstruct.theexif#" arguments="-a -g #attributes.intstruct.qryfile.path#" timeout="60" variable="file_meta" />
					...
					<!--- MD5 Hash
					<cfset md5hash = hashbinary(attributes.intstruct.theorgfileraw)> --->
					...
					<cfelse>
						...
						<cfif attributes.intstruct.storage EQ "local" AND attributes.intstruct.qryfile.link_kind NEQ "url">
							<!--- In case folder exists remove it --->
							<cftry>
								<cfdirectory action="delete" recurse="yes" directory="#attributes.intstruct.qrysettings.set2_path_to_assets#/#attributes.intstruct.hostid#/#attributes.intstruct.qryfile.folder_id#/doc/#attributes.intstruct.newid#">
								<cfcatch type="any"></cfcatch>
							</cftry>
...
<cffunction name="processImgFile" output="true">
	...
	<cfelse>
		...
		<cfif arguments.thestruct.newid EQ 0>
			<cfinvoke component="email" method="send_email" dsn="#arguments.thestruct.dsn#" setid="#arguments.thestruct.setid#" subject="Image #arguments.thestruct.qryfile.filename# not added" themessage="Unfortunately, we could not add your image #arguments.thestruct.qryfile.filename# to the system because we can't recognize it as an image!">
			<!--- Log --->
...
--->
								<cfinvoke component="amazon" method="Upload">
									<cfinvokeargument name="key" value="/#arguments.thestruct.qryfile.folder_id#/img/#arguments.thestruct.newid#/#attributes.intstruct.qryfile.filename#">
									<cfinvokeargument name="theasset" value="#arguments.thestruct.qryfile.path#/#arguments.thestruct.qryfile.filename#">
...
--->
							<cfinvoke component="amazon" method="Upload">
								<cfinvokeargument name="key" value="/#arguments.thestruct.qryfile.folder_id#/img/#arguments.thestruct.newid#/thumb_#arguments.thestruct.newid#.#arguments.thestruct.qrysettings.set2_img_format#">
								<cfinvokeargument name="theasset" value="#arguments.thestruct.destination#">
								<cfinvokeargument name="awsbucket" value="#arguments.thestruct.awsbucket#">
							</cfinvoke>
						<!---
</cfthread>
	...
	<cftry>
		...
		<cfswitch expression="#arguments.thestruct.qryfile.extension#">
			...
			<cfcase value="3fr,ari,arw,srf,sr2,bay,crw,cr2,cap,iiq,eip,dcs,dcr,drf,k25,kdc,erf,fff,mef,mos,mrw,nef,nrw,orf,ptx,pef,pxn,r3d,raf,raw,rw2,rwl,dng,rwz,x3f">
				<cfset arguments.thestruct.theimarguments = "#arguments.thestruct.thedcraw# -c -e #arguments.thestruct.thesource# > #Arguments.thestruct.destination# | #arguments.thestruct.themogrify# #theImgConvertParams# #Arguments.thestruct.destination#">
			</cfcase>
			<!--- For everything else --->
			<cfdefaultcase>
	...
	<cfelse>	
		...
		<cfif arguments.thestruct.qryfile.link_kind NEQ "url">
			...
			<cfif application.razuna.storage EQ "local">
				...
				<!--- Move original --->
				<cfif arguments.thestruct.qryfile.link_kind NEQ "lan">
					<cffile action="move" source="#arguments.thestruct.qryfile.path#/#arguments.thestruct.qryfile.filename#" destination="#arguments.thestruct.thisvid.finalpath#/#arguments.thestruct.qryfile.filename#" mode="775">
				</cfif>
			<!--- For NIRVANIX --->
			...
			<cfif isWindows()>
				...
				<cfset arguments.thestruct.theexif = """#arguments.thestruct.thetools.exiftool#/exiftool.exe""">
				<cfset arguments.thestruct.theorg = """#arguments.thestruct.thisvid.finalpath#/#arguments.thestruct.thisvid.theorgimage#""">
				<!--- If local link --->
				<cfif arguments.thestruct.qryfile.link_kind EQ "lan">
			...
			<!--- Hash Video --->
			<!--- <cfset md5hash = hashbinary(arguments.thestruct.theassetraw)> --->
			<!--- Get image width --->
			...
			<cfif application.razuna.storage EQ "nirvanix">
				...
				<cfthread name="#upmi#" intstruct="#arguments.thestruct#">
					<cfinvoke component="nirvanix" method="Upload">
						...
						<cfinvokeargument name="uploadfile" value="#attributes.intstruct.qryfile.path#/#attributes.intstruct.thisvid.theorgimage#">
						<cfinvokeargument name="nvxsession" value="#attributes.intstruct.nvxsession#">
					</cfinvoke>
				</cfthread>
...
<cfinvoke component="nirvanix" method="Upload">
					...
					<cfinvokeargument name="uploadfile" value="#arguments.thestruct.qryfile.path#/#arguments.thestruct.thisvid.theorgimage#">
					<cfinvokeargument name="nvxsession" value="#arguments.thestruct.nvxsession#">
				</cfinvoke>
--->
				<!--- Upload Movie --->
			...
			<cfelseif application.razuna.storage EQ "amazon">
				...
				<cfthread name="#upmi#" intstruct="#arguments.thestruct#">
					<cfinvoke component="amazon" method="Upload">
						...
						<cfinvokeargument name="theasset" value="#attributes.intstruct.qryfile.path#/#attributes.intstruct.thisvid.theorgimage#">
						<cfinvokeargument name="awsbucket" value="#attributes.intstruct.awsbucket#">
					</cfinvoke>
				</cfthread>
				<cfthread action="join" name="#upmi#" />
				...
				<!---
<cfinvoke component="amazon" method="Upload">
					<cfinvokeargument name="key" value="/#arguments.thestruct.qryfile.folder_id#/vid/#arguments.thestruct.thisvid.newid#/#arguments.thestruct.thisvid.theorgimage#">
					<cfinvokeargument name="theasset" value="#arguments.thestruct.qryfile.path#/#arguments.thestruct.thisvid.theorgimage#">
					<cfinvokeargument name="awsbucket" value="#arguments.thestruct.awsbucket#">
				</cfinvoke>
--->
				<!--- Upload Movie --->
				<cfif arguments.thestruct.qryfile.link_kind NEQ "lan">
					...
					<!---
<cfinvoke component="amazon" method="Upload">
						<cfinvokeargument name="key" value="/#arguments.thestruct.qryfile.folder_id#/vid/#arguments.thestruct.thisvid.newid#/#arguments.thestruct.qryfile.filename#">
						<cfinvokeargument name="theasset" value="#arguments.thestruct.qryfile.path#/#arguments.thestruct.qryfile.filename#">
						<cfinvokeargument name="awsbucket" value="#arguments.thestruct.awsbucket#">
					</cfinvoke>
--->
		...
		,
		folder_id_r  = <cfqueryparam cfsqltype="CF_SQL_VARCHAR" value="#arguments.thestruct.qryfile.folder_id#">,
		...
		path_to_asset = <cfqueryparam value="#arguments.thestruct.qryfile.folder_id#/vid/#arguments.thestruct.thisvid.newid#" cfsqltype="cf_sql_varchar">,
		is_available = <cfqueryparam value="1" cfsqltype="cf_sql_varchar">,
...
<!--- PROCESS A AUDIO-FILE -------------------------------------------------------------------->
	...
	<cfargument name="thestruct" type="struct">
		...
		<cfif qrysamefile.recordcount EQ 0>
			<!--- Get new id --->
			<!--- <cfinvoke component="global" method="getsequence" returnvariable="newid" database="#variables.database#" dsn="#variables.dsn#" thetable="#session.hostdbprefix#files" theid="file_id"> --->
			<cfset arguments.thestruct.newid = arguments.thestruct.qryfile.tempid>
			<cfquery datasource="#variables.dsn#">
				...
				<cfelse>
					...
					<cfif attributes.audstruct.qryfile.link_kind NEQ "url">
						...
						<cfif attributes.audstruct.qryfile.link_kind EQ "lan">
							<!--- Create var with temp directory --->
							<cfset attributes.audstruct.thetempdirectory = "#attributes.audstruct.thepath#/incoming/asset#createuuid()#">
						...
						<!--- MD5 Hash --->
						<!--- <cfset md5hash = hashbinary(attributes.audstruct.theorgfileraw)> --->
						<!--- Write the script --->
						...
						<!--- <cfthread name="wav#attributes.audstruct.newid.id#" intaudstruct="#attributes.audstruct#"> --->
							<cfif attributes.audstruct.qryfile.extension NEQ "wav">
								...
								<!--- Execute --->
								<cfexecute name="#attributes.audstruct.thesh#" timeout="60" />
								<!--- Delete scripts --->
								<cffile action="delete" file="#attributes.audstruct.thesh#">
							</cfif>
						...
						<!--- <cfthread action="join" name="wav#attributes.audstruct.newid.id#" /> --->
					<!--- If link_kind is url --->
					<cfelse>
						<cfset var idtags = "">
					</cfif>
					...
					<cftransaction>
						...
						<cfif attributes.audstruct.storage EQ "nirvanix" OR application.razuna.storage EQ "amazon">
							, lucene_key = <cfqueryparam value="#attributes.audstruct.qryfile.path#/#attributes.audstruct.qryfile.filename#" cfsqltype="cf_sql_varchar">
						</cfif>
					...
					<cfif attributes.audstruct.qryfile.link_kind NEQ "url">
						...
						<cfif attributes.audstruct.storage EQ "local">
							...
							<cfif attributes.audstruct.qryfile.link_kind NEQ "lan">
								<cffile action="move" source="#attributes.audstruct.qryfile.path#/#attributes.audstruct.qryfile.filename#" destination="#attributes.audstruct.qrysettings.set2_path_to_assets#/#attributes.audstruct.hostid#/#attributes.audstruct.qryfile.folder_id#/aud/#attributes.audstruct.newid#/#attributes.audstruct.qryfile.filename#" mode="775">
							</cfif>
							<!--- Move the WAV --->
							<cfif attributes.audstruct.qryfile.extension NEQ "wav">
							...
							<cfif attributes.audstruct.qryfile.link_kind NEQ "lan">
								...
								<cfthread name="#upa#" audstruct="#attributes.audstruct#">
									<cfinvoke component="nirvanix" method="Upload">
										...
										<cfinvokeargument name="uploadfile" value="#attributes.audstruct.thetempdirectory#/#attributes.audstruct.qryfile.filename#">
							...
							<cfif attributes.audstruct.qryfile.link_kind NEQ "lan">
								...
								<cfthread name="#upa#" audstruct="#attributes.audstruct#">
									<cfinvoke component="amazon" method="Upload">
										...
										<cfinvokeargument name="theasset" value="#attributes.audstruct.thetempdirectory#/#attributes.audstruct.qryfile.filename#">
...
<cffunction name="recreatepreviewimagethread" output="true" access="public">
	...
	<cfloop list="#arguments.thestruct.file_id#" index="i" delimiters=",">
		...
		<cfelseif application.razuna.storage EQ "amazon">
			...
			<cfthread name="download#thescript#" intstruct="#arguments.thestruct#">
				<!--- <cfinvoke component="amazon" method="Download">
					<cfinvokeargument name="key" value="/#attributes.intstruct.qry_existing.path_to_asset#/#attributes.intstruct.qry_existing.orgname#">
					<cfinvokeargument name="theasset" value="#attributes.intstruct.filepath##attributes.intstruct.qry_existing.orgname#">
					<cfinvokeargument name="awsbucket" value="#attributes.intstruct.awsbucket#">
				</cfinvoke> --->
		...
		<cfelseif application.razuna.storage EQ "nirvanix">
			...
			<cfthread name="download#thescript#" intstruct="#arguments.thestruct#">
				<!---
<cfinvoke component="nirvanix" method="Download">
					<cfinvokeargument name="remotefile" value="/#attributes.intstruct.qry_existing.path_to_asset#/#attributes.intstruct.qry_existing.orgname#">
					<cfinvokeargument name="localfile" value="#attributes.intstruct.filepath##attributes.intstruct.qry_existing.orgname#">
					<cfinvokeargument name="nvxsession" value="#attributes.intstruct.nvxsession#">
				</cfinvoke>
--->
				<cfhttp url="#attributes.intstruct.qry_existing.cloud_url_org#" method="get" path="#attributes.intstruct.filepath#" file="#attributes.intstruct.qry_existing.orgname#" getAsBinary="yes" />
