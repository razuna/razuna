...
<cfcomponent output="false">
	...
	<cffunction name="setup" access="public" output="false">
		...
		(
			...
			rfs_date_add 	TIMESTAMP NULL,
			rfs_date_change TIMESTAMP NULL,
			PRIMARY KEY (rfs_id)
		)
		#this.tableoptions#
		</cfquery>
	...
	<cffunction name="create_tables" access="public" output="false">
		...
		(
		  ...
		  CART_CREATE_TIME  	TIMESTAMP NULL,
		  CART_CHANGE_DATE  	DATE,
		  CART_CHANGE_TIME  	TIMESTAMP NULL,
		  ...
		  cart_order_artofvideo	LONGTEXT,
		  cart_order_artofaudio	LONGTEXT,
		  cart_order_artoffile	LONGTEXT,
		  HOST_ID				INT,
		...
		(
		  ...
		  FOLDER_CREATE_TIME    TIMESTAMP NULL,
		  FOLDER_CHANGE_DATE    DATE,
		  FOLDER_CHANGE_TIME    TIMESTAMP NULL,
		...
		(
		  ...
		  FILE_CREATE_TIME     TIMESTAMP NULL,
		  FILE_CHANGE_DATE     DATE,
		  FILE_CHANGE_TIME     TIMESTAMP NULL,
		  ...
		  change_date_user    TIMESTAMP NULL DEFAULT NULL,
		  change_date_file    TIMESTAMP NULL DEFAULT NULL,
		PRIMARY KEY (FILE_ID),
		...
		(
		  ...
		  IMG_CREATE_TIME     TIMESTAMP NULL,
		  IMG_CHANGE_DATE     DATE,
		  IMG_CHANGE_TIME     TIMESTAMP NULL,
		  IMG_RANKING         INT,
		...
		(
		  ...
		  SET2_RENDITION_SEARCH  VARCHAR(1) DEFAULT 'f',
		  PRIMARY KEY (rec_uuid),
		...
		VID_CREATE_TIME			TIMESTAMP NULL,
		VID_CHANGE_DATE			DATE,
		VID_CHANGE_TIME			TIMESTAMP NULL,
		VID_RANKING				INT,
		...
		(
			...
			SCHED_START_TIME     TIMESTAMP NULL,
			SCHED_END_DATE       DATE,
			SCHED_END_TIME       TIMESTAMP NULL,
			SCHED_RUN_TIME       TIMESTAMP NULL,
			HOST_ID				 INT,
		...
		(
			...
			aud_CREATE_TIME     TIMESTAMP NULL,
			aud_CHANGE_DATE     DATE,
			aud_CHANGE_TIME     TIMESTAMP NULL,
		...
		imp_temp_id 		varchar(100),
  		imp_date_create	 	TIMESTAMP NULL,
  		imp_date_update		TIMESTAMP NULL,
  		imp_who				varchar(100),
		...
		(
			sf_id 			varchar(100),
			sf_name 		varchar(500),
			sf_date_create 	TIMESTAMP NULL,
			sf_date_update 	TIMESTAMP NULL,
			sf_type 		varchar(100),
		...
		(
			...
			last_mail_notification_time TIMESTAMP NULL,
