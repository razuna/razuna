...
<cffunction name="relatedvideos" output="true">
	...
	<!--- Query --->
	<cfquery datasource="#application.razuna.datasource#" name="qry" cachedwithin="1" region="razcache">
	SELECT /* #variables.cachetoken#relatedvideosvid */ v.vid_id, v.folder_id_r, v.vid_filename, v.vid_extension, v.vid_height, v.vid_width, v.vid_size vlength, v.vid_name_org, v.path_to_asset, v.cloud_url_org, v.cloud_url, v.vid_group, v.hashtag, v.vid_name_image, v.link_kind
	FROM #session.hostdbprefix#videos v
...
<cffunction name="convertvideo" output="true">
	...
	<cftry>
		...
		<cfloop delimiters="," list="#arguments.thestruct.convert_to#" index="theformat">
			...
			<cfif _is_error>
				<cfset log_assets(theuserid=session.theuserid,logaction='Convert',logdesc='ERROR converting: #arguments.thestruct.qrydetail.vid_name_org# to #previewvideo# #_convert_error#',logfiletype='vid',assetid='#arguments.thestruct.file_id#',folderid='#arguments.thestruct.qrydetail.folder_id_r#')>
				<!--- Delete scripts --->
				<cffile action="delete" file="#arguments.thestruct.thesh#">
			...
			<cfelse>
				...
				<cfif application.razuna.storage EQ "local">
					...
					<!--- Move video --->
					<cffile action="#_file_action#" source="#thisfolder#/#previewvideo#" destination="#arguments.thestruct.assetpath#/#session.hostid#/#arguments.thestruct.qrydetail.folder_id_r#/vid/#arguments.thestruct.newid#" mode="775">
					<!--- Move still image --->
					<cffile action="#_file_action#" source="#thisfolder#/#previewimage#" destination="#arguments.thestruct.assetpath#/#session.hostid#/#arguments.thestruct.qrydetail.folder_id_r#/vid/#arguments.thestruct.newid#" mode="775">
