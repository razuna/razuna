...
<cffunction name="getdirectory" output="true">
    ...
    <cftry>
    	<cfset var o = ftpopen(server=arguments.thestruct.razuna.session.ftp_server,username=arguments.thestruct.razuna.session.ftp_user,password=arguments.thestruct.razuna.session.ftp_pass,passive=arguments.thestruct.razuna.session.ftp_passive,stoponerror=true)>
    	<cfcatch>
    ...
    <cfif o.succeeded>    
        <cfif NOT structkeyexists(arguments.thestruct,"folderpath")>
            ...
            <cfset dirlist = ftplist(o,thedirname,arguments.thestruct.razuna.session.ftp_passive)>
        <cfelse>
        	<cftry>
                ...
                <cfset dirlist = ftplist(o,arguments.thestruct.folderpath,arguments.thestruct.razuna.session.ftp_passive)>
            	<cfcatch type="any">
...
<cffunction  name="putfile" output="true">
	...
	<cftry>
        <!--- Open ftp connection --->
        <cfset var o = ftpopen(server=arguments.thestruct.razuna.session.ftp_server,username=arguments.thestruct.razuna.session.ftp_user,password=arguments.thestruct.razuna.session.ftp_pass,passive=arguments.thestruct.razuna.session.ftp_passive,stoponerror=false, timeout=3000)>
		<cfif structKeyExists(arguments.thestruct.razuna.session,"createzip") AND arguments.thestruct.razuna.session.createzip EQ 'no'>
			...
			<cfif myDir.RecordCount>
				<cfloop query="myDir">
					...
					<cfdirectory action="list" directory="#arguments.thestruct.thepath#/outgoing/#arguments.thestruct.thefile#/#myDir.name#" name="myFile" type="file">
						<cfif !Ftpexistsfile(ftpdata=o, file="#arguments.thestruct.folderpath#/#myFile.name#", passive=arguments.thestruct.razuna.session.ftp_passive, stoponerror=false)>
							<!--- Put the file on the FTP Site --->
							<cfset Ftpputfile(ftpdata=o, remotefile="#arguments.thestruct.folderpath#/#myFile.name#", localfile="#arguments.thestruct.thepath#/outgoing/#arguments.thestruct.thefile#/#myDir.name#/#myFile.name#", passive=arguments.thestruct.razuna.session.ftp_passive)>
						<cfelse>
							...
							<!--- Put the file on the FTP Site --->
							<cfset Ftpputfile(ftpdata=o, remotefile="#arguments.thestruct.folderpath#/#new_name#", localfile="#arguments.thestruct.thepath#/outgoing/#arguments.thestruct.thefile#/#myDir.name#/#new_name#", passive=arguments.thestruct.razuna.session.ftp_passive)>
						</cfif>
				</cfloop>
			...
			<cfelse>
				...
				<cfif !Ftpexistsfile(ftpdata=o ,file="#arguments.thestruct.folderpath#/#myFile.name#", passive=arguments.thestruct.razuna.session.ftp_passive, stoponerror=false)>
					<cfset Ftpputfile(ftpdata=o, remotefile="#arguments.thestruct.folderpath#/#myFile.name#", localfile="#arguments.thestruct.thepath#/outgoing/#arguments.thestruct.thefile#/#myFile.name#", passive=arguments.thestruct.razuna.session.ftp_passive)>
				<cfelse>
					<cfset listftp = Ftplist(ftpdata=o, directory="#arguments.thestruct.folderpath#")>
					<cfquery name="q" dbtype="query" >
						SELECT * FROM listftp
					...
					<cfset Ftpputfile(ftpdata=o, remotefile="#arguments.thestruct.folderpath#/#new_name#", localfile="#arguments.thestruct.thepath#/outgoing/#arguments.thestruct.thefile#/#new_name#", passive=arguments.thestruct.razuna.session.ftp_passive)>
				</cfif>	
				<!--- Delete the folder in the outgoing folder --->
				<cfdirectory action="delete" directory="#arguments.thestruct.thepath#/outgoing/#arguments.thestruct.thefile#" recurse="true">
			</cfif>
		<cfelse>
			<cfif !Ftpexistsfile(ftpdata=o ,file="#arguments.thestruct.folderpath#/#arguments.thestruct.thefile#", passive=arguments.thestruct.razuna.session.ftp_passive, stoponerror=true)>
				<!--- Put the file on the FTP Site --->
				<cfset Ftpputfile(ftpdata=o, remotefile="#arguments.thestruct.folderpath#/#arguments.thestruct.thefile#", localfile="#arguments.thestruct.thepath#/outgoing/#arguments.thestruct.thefile#", passive=arguments.thestruct.razuna.session.ftp_passive)>
			...
			<cfelse>
				...
				<!--- Put the file on the FTP Site --->
				<cfset Ftpputfile(ftpdata=o, remotefile="#arguments.thestruct.folderpath#/#new_name#", localfile="#arguments.thestruct.thepath#/outgoing/#new_name#", passive=arguments.thestruct.razuna.session.ftp_passive)>
				<!--- Delete the file in the outgoing folder --->
