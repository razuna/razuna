<cfcomponent>
	...
	<cffunction name="migrate_files" output="yes">
		...
		<cfquery datasource="#arguments.thestruct.db_local#" name="qry_setting">
		...
		<cfloop query="qry_folders">
			<cfif !directoryexists("#arguments.thestruct.thepath#/#arguments.thestruct.hostid#/#folder_id#")>
				<cfdirectory action="create" directory="#arguments.thestruct.thepath#/#arguments.thestruct.hostid#/#folder_id#" mode="775" />
				<cfdirectory action="create" directory="#arguments.thestruct.thepath#/#arguments.thestruct.hostid#/#folder_id#/doc" mode="775" />
				<cfdirectory action="create" directory="#arguments.thestruct.thepath#/#arguments.thestruct.hostid#/#folder_id#/img" mode="775" />
				<cfdirectory action="create" directory="#arguments.thestruct.thepath#/#arguments.thestruct.hostid#/#folder_id#/vid" mode="775" />
				<cfdirectory action="create" directory="#arguments.thestruct.thepath#/#arguments.thestruct.hostid#/#folder_id#/aud" mode="775" />
			</cfif>
		</cfloop>
	...
	<cffunction name="getnirvanix" output="yes">
		...
		<cfloop query="qry">
			<!--- Create id folder --->
			<cfif !directoryexists("#arguments.thestruct.thepath#/#arguments.thestruct.hostid#/#path_to_asset#")>
				<cfdirectory action="create" directory="#arguments.thestruct.thepath#/#arguments.thestruct.hostid#/#path_to_asset#" mode="775" />
			</cfif>
			...
			<!--- Get org --->
			<cfif !fileexists("#arguments.thestruct.thepath#/#arguments.thestruct.hostid#/#path_to_asset#/#oname#")>
				<cfexecute name="/usr/bin/wget" arguments="-P #arguments.thestruct.thepath#/#arguments.thestruct.hostid#/#path_to_asset# #cloud_url_org#" timeout="9999" />
			</cfif>
		</cfloop>
	</cffunction>
