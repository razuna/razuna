...
<message>Login not valid! Check user API Key and ensure with your administrator that the user has appropriate permissions for access.</message>
	...
	<cffunction name="getcachetoken" output="false" returntype="string">
		...
		<!--- Call reset function --->
		<cfinvoke component="global.cfc.extQueryCaching" method="getcachetoken" type="#arguments.type#" hostid="#session.hostid#" returnvariable="c" />
		<!--- Return --->
		<cfreturn c />
	</cffunction>
	...
	<cffunction name="resetcachetoken" output="false" returntype="void">
		...
		<cfinvoke component="global.cfc.extQueryCaching" method="resetcachetokenall(hostid=session.hostid, thestruct=thestruct)" />
		<!--- Return --->
		<cfreturn />
	</cffunction>
