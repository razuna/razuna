		...
		<cfif thesession>
			...
			<cfif qry_col.recordcount NEQ 0>
				...
				<cfif application.razuna.api.thedatabase EQ "oracle" OR application.razuna.api.thedatabase EQ "mysql" OR application.razuna.api.thedatabase EQ "h2">
					concat('#variables.thehttp##cgi.HTTP_HOST#/#application.razuna.api.dynpath#/assets/#application.razuna.api.hostid["#arguments.api_key#"]#/',i.path_to_asset,'/',i.img_filename_org) AS local_url_org,
					concat('#variables.thehttp##cgi.HTTP_HOST#/#application.razuna.api.dynpath#/assets/#application.razuna.api.hostid["#arguments.api_key#"]#/',i.path_to_asset,'/','thumb_',i.img_id,'.',i.thumb_extension) AS local_url_thumb,
				<cfelseif application.razuna.api.thedatabase EQ "mssql">
					'#variables.thehttp##cgi.HTTP_HOST#/#application.razuna.api.dynpath#/assets/#application.razuna.api.hostid["#arguments.api_key#"]#/' + i.path_to_asset + '/' + i.img_filename_org AS local_url_org,
					'#variables.thehttp##cgi.HTTP_HOST#/#application.razuna.api.dynpath#/assets/#application.razuna.api.hostid["#arguments.api_key#"]#/' + i.path_to_asset + '/' + 'thumb_' + i.img_id + '.' + i.thumb_extension AS local_url_thumb,
				</cfif>
				CASE
				...
				CASE
					WHEN (ct.col_file_format = 'original' OR ct.col_file_format = 'thumb') THEN 
						<cfif application.razuna.api.thedatabase EQ "oracle" OR application.razuna.api.thedatabase EQ "mysql" OR application.razuna.api.thedatabase EQ "h2">
							concat('#variables.thehttp##cgi.HTTP_HOST#/#application.razuna.api.dynpath#/assets/#application.razuna.api.hostid["#arguments.api_key#"]#/',i.path_to_asset,'/',i.img_filename_org)
						<cfelseif application.razuna.api.thedatabase EQ "mssql">
							'#variables.thehttp##cgi.HTTP_HOST#/#application.razuna.api.dynpath#/assets/#application.razuna.api.hostid["#arguments.api_key#"]#/' + i.path_to_asset + '/' + i.img_filename_org
						</cfif>
					ELSE 
						<cfif application.razuna.api.thedatabase EQ "oracle" OR application.razuna.api.thedatabase EQ "mysql" OR application.razuna.api.thedatabase EQ "h2">
							concat('#variables.thehttp##cgi.HTTP_HOST#/#application.razuna.api.dynpath#/assets/#application.razuna.api.hostid["#arguments.api_key#"]#/',(SELECT path_to_asset FROM #application.razuna.api.prefix["#arguments.api_key#"]#images WHERE img_id = ct.col_file_format),'/',(SELECT img_filename_org FROM #application.razuna.api.prefix["#arguments.api_key#"]#images WHERE img_id = ct.col_file_format))
						<cfelseif application.razuna.api.thedatabase EQ "mssql">
							'#variables.thehttp##cgi.HTTP_HOST#/#application.razuna.api.dynpath#/assets/#application.razuna.api.hostid["#arguments.api_key#"]#/' + (SELECT path_to_asset FROM #application.razuna.api.prefix["#arguments.api_key#"]#images WHERE img_id = ct.col_file_format) + '/' + (SELECT img_filename_org FROM #application.razuna.api.prefix["#arguments.api_key#"]#images WHERE img_id = ct.col_file_format)
						</cfif>
				...
				<cfif application.razuna.api.thedatabase EQ "oracle" OR application.razuna.api.thedatabase EQ "mysql" OR application.razuna.api.thedatabase EQ "h2">
					concat('#variables.thehttp##cgi.HTTP_HOST#/#application.razuna.api.dynpath#/assets/#application.razuna.api.hostid["#arguments.api_key#"]#/',v.path_to_asset,'/',v.vid_name_org) AS local_url_org,
					concat('#variables.thehttp##cgi.HTTP_HOST#/#application.razuna.api.dynpath#/assets/#application.razuna.api.hostid["#arguments.api_key#"]#/',v.path_to_asset,'/',v.vid_name_image) AS local_url_thumb,
				<cfelseif application.razuna.api.thedatabase EQ "mssql">
					'#variables.thehttp##cgi.HTTP_HOST#/#application.razuna.api.dynpath#/assets/#application.razuna.api.hostid["#arguments.api_key#"]#/' + v.path_to_asset + '/' + v.vid_name_org AS local_url_org,
					'#variables.thehttp##cgi.HTTP_HOST#/#application.razuna.api.dynpath#/assets/#application.razuna.api.hostid["#arguments.api_key#"]#/' + v.path_to_asset + '/' + v.vid_name_image AS local_url_thumb,
				</cfif>
				CASE
				...
				CASE
					WHEN (ct.col_file_format = 'video') THEN 
						<cfif application.razuna.api.thedatabase EQ "oracle" OR application.razuna.api.thedatabase EQ "mysql" OR application.razuna.api.thedatabase EQ "h2">
							concat('#variables.thehttp##cgi.HTTP_HOST#/#application.razuna.api.dynpath#/assets/#application.razuna.api.hostid["#arguments.api_key#"]#/',v.path_to_asset,'/',v.vid_name_org)
						<cfelseif application.razuna.api.thedatabase EQ "mssql">
							'#variables.thehttp##cgi.HTTP_HOST#/#application.razuna.api.dynpath#/assets/#application.razuna.api.hostid["#arguments.api_key#"]#/' + v.path_to_asset + '/' + v.vid_name_org
						</cfif>
					ELSE 
						<cfif application.razuna.api.thedatabase EQ "oracle" OR application.razuna.api.thedatabase EQ "mysql" OR application.razuna.api.thedatabase EQ "h2">
							concat('#variables.thehttp##cgi.HTTP_HOST#/#application.razuna.api.dynpath#/assets/#application.razuna.api.hostid["#arguments.api_key#"]#/',(SELECT path_to_asset FROM #application.razuna.api.prefix["#arguments.api_key#"]#videos WHERE vid_id = ct.col_file_format),'/',(SELECT vid_name_org FROM #application.razuna.api.prefix["#arguments.api_key#"]#videos WHERE vid_id = ct.col_file_format))
						<cfelseif application.razuna.api.thedatabase EQ "mssql">
							'#variables.thehttp##cgi.HTTP_HOST#/#application.razuna.api.dynpath#/assets/#application.razuna.api.hostid["#arguments.api_key#"]#/' + (SELECT path_to_asset FROM #application.razuna.api.prefix["#arguments.api_key#"]#videos WHERE vid_id = ct.col_file_format) + '/' + (SELECT vid_name_org FROM #application.razuna.api.prefix["#arguments.api_key#"]#videos WHERE vid_id = ct.col_file_format)
						</cfif>
				END as rendition_url,
				'' AS colorspace,
				'' AS xdpi,
				...
				<cfif application.razuna.api.thedatabase EQ "oracle" OR application.razuna.api.thedatabase EQ "mysql" OR application.razuna.api.thedatabase EQ "h2">
					concat('#variables.thehttp##cgi.HTTP_HOST#/#application.razuna.api.dynpath#/assets/#application.razuna.api.hostid["#arguments.api_key#"]#/',a.path_to_asset,'/',a.aud_name_org) AS local_url_org,
				<cfelseif application.razuna.api.thedatabase EQ "mssql">
					'#variables.thehttp##cgi.HTTP_HOST#/#application.razuna.api.dynpath#/assets/#application.razuna.api.hostid["#arguments.api_key#"]#/' + a.path_to_asset + '/' + a.aud_name_org AS local_url_org,
				</cfif>
				...
				CASE
					WHEN (ct.col_file_format = '' OR ct.col_file_format = 'audio') THEN 
						<cfif application.razuna.api.thedatabase EQ "oracle" OR application.razuna.api.thedatabase EQ "mysql" OR application.razuna.api.thedatabase EQ "h2">
							concat('#variables.thehttp##cgi.HTTP_HOST#/#application.razuna.api.dynpath#/assets/#application.razuna.api.hostid["#arguments.api_key#"]#/',a.path_to_asset,'/',a.aud_name_org)
						</cfif>
					ELSE 
						<cfif application.razuna.api.thedatabase EQ "oracle" OR application.razuna.api.thedatabase EQ "mysql" OR application.razuna.api.thedatabase EQ "h2">
							concat('#variables.thehttp##cgi.HTTP_HOST#/#application.razuna.api.dynpath#/assets/#application.razuna.api.hostid["#arguments.api_key#"]#/',(SELECT path_to_asset FROM #application.razuna.api.prefix["#arguments.api_key#"]#audios WHERE aud_id = ct.col_file_format),'/',(SELECT aud_name_org FROM #application.razuna.api.prefix["#arguments.api_key#"]#audios WHERE aud_id = ct.col_file_format))
						<cfelseif application.razuna.api.thedatabase EQ "mssql">
							'#variables.thehttp##cgi.HTTP_HOST#/#application.razuna.api.dynpath#/assets/#application.razuna.api.hostid["#arguments.api_key#"]#/' + (SELECT path_to_asset FROM #application.razuna.api.prefix["#arguments.api_key#"]#audios WHERE aud_id = ct.col_file_format) + '/' + (SELECT aud_name_org FROM #application.razuna.api.prefix["#arguments.api_key#"]#audios WHERE aud_id = ct.col_file_format)
						</cfif>
				END as rendition_url,
				'' AS colorspace,
				'' AS xdpi,
				...
				'false' as subassets,
				<cfif application.razuna.api.thedatabase EQ "oracle" OR application.razuna.api.thedatabase EQ "mysql" OR application.razuna.api.thedatabase EQ "h2">
					concat('#variables.thehttp##cgi.HTTP_HOST#/#application.razuna.api.dynpath#/assets/#application.razuna.api.hostid["#arguments.api_key#"]#/',f.path_to_asset,'/',f.file_name_org) AS local_url_org,
				<cfelseif application.razuna.api.thedatabase EQ "mssql">
					'#variables.thehttp##cgi.HTTP_HOST#/#application.razuna.api.dynpath#/assets/#application.razuna.api.hostid["#arguments.api_key#"]#/' + f.path_to_asset + '/' + f.file_name_org AS local_url_org,
				</cfif>
				'0' as local_url_thumb,
				'0' as rendition_id,
				'0' as rendition_url,
