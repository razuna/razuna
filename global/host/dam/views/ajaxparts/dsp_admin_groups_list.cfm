	...
	<div id="grpdamlist">
		...
		<!--- Groups of tenant --->
			<cfloop query="qry_groups">
				<tr class="list">
					<td valign="top" nowrap width="100%"><a href="##" onclick="showwindow('#myself#c.groups_detail&grp_id=#grp_id#&kind=#kind#&loaddiv=#loaddiv#','#Encodeforjavascript(grp_name)#',700,1);return false;">#grp_name#</a> (#usercount# members) <em>(ID: #grp_id#)</em></td>
