		...
		<tr>
			<td width="100%" nowrap="true" valign="top" colspan="2">
				<cfloop query="qry_related">
					...
					| <a href="##" onclick="showwindow('#myself#c.exist_rendition_audios&file_id=#aud_id#&aud_group_id=#aud_group#&thetype=aud&cf_show=aud&folder_id=#folder_id#&what=#what#','Renditions',875,2);return false;">Renditions</a>
