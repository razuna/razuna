...
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="grid">
	...
	<tr>
		<td class="td2"><strong>#myFusebox.getApplicationData().defaults.trans("credit")#</strong></td>
	...
	<tr>
		<td class="td2"><strong>#myFusebox.getApplicationData().defaults.trans("source")#</strong></td>
	...
	<tr>
		<td class="td2" valign="top"><strong>#myFusebox.getApplicationData().defaults.trans("instructions")#</strong></td>
	...
	<tr>
		<td class="td2" nowrap="nowrap" valign="top"><strong>#myFusebox.getApplicationData().defaults.trans("transmission_reference")#</strong></td>
	...
	<tr>
		<td class="td2"><strong>#myFusebox.getApplicationData().defaults.trans("urgency")#</strong></td>
		<td class="td2" width="100%"><select name="xmp_origin_urgency">
		<option value="1"<cfif #qry_xmp.urgency# EQ "1"> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans("high")#</option>
		...
		<option value="5"<cfif #qry_xmp.urgency# EQ "5"> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans("normal")#</option>
		...
		<option value="8"<cfif #qry_xmp.urgency# EQ "8"> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans("low")#</option>
		<option value=""<cfif #qry_xmp.urgency# EQ ""> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans("none")#</option>
		</select></td>
	</tr>
	<tr>
		<td class="td2"></td>
