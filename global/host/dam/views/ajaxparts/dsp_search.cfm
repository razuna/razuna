...
<cfoutput>
	...
	<div>
		...
		<div style="padding:0;margin:0;">
			<div id="search_tab">
				<ul>
					<li><a href="##content_search_all" onclick="<cfif attributes.share NEQ 't'>switchsearchtab('all');</cfif>">#myFusebox.getApplicationData().defaults.trans("searchresults_header")# (#session.search.total_records#)</a></li>
				</ul>
