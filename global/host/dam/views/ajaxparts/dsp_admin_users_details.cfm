		...
		<!--- WEB GROUPS --->
			<tr>
				<td valign="top">
					...
					<cfif session.securityobj.CheckSystemAdminUser() OR session.securityobj.CheckAdministratorUser() OR tabaccess_struct.groups_access>
						<!--- We come from myinfo --->
						<cfif attributes.myinfo>
							...
							<cfelseif session.securityobj.CheckAdministratorUser()>
