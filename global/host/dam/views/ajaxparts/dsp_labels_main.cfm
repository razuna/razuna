	...
	<div id="labels_tab">
		<ul>	
			...
			<cfif Request.securityobj.CheckSystemAdminUser() OR Request.securityobj.CheckAdministratorUser()>
				<li><a href="##lab_prop" onclick="loadcontent('lab_prop','#myself#c.labels_main_properties&label_id=#attributes.label_id#');">Label #defaultsObj.trans("settings")#</a></li>
			</cfif>
		</ul>
		...
		<cfif Request.securityobj.CheckSystemAdminUser() OR Request.securityobj.CheckAdministratorUser()><div id="lab_prop">#defaultsObj.loadinggif("#dynpath#")#</div></cfif>
	</div>
