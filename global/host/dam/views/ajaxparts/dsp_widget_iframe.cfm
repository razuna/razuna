									...
									<div class="theimg">
										...
										<cfif link_kind NEQ "url">
											...
											<cfelse>
												...
												<a href="##" onclick="window.open('#myself#c.si&f=#theid#&v=#thev#&jsessionid=#session.SessionID#','#theid#','left=20,top=20,width=500,height=500,toolbar=0,resizable=1,location=0,status=0,menubar=0,history=0');"><img src="#thestorage##path_to_asset#/thumb_#id#.#ext#" border="0"></a>
											</cfif>
										<cfelse>
									...
									<div class="theimg">
										<cfif link_kind NEQ "url">
											...
											<cfelse>
												...
												<a href="##" onclick="window.open('#myself#c.sv&f=#theid#&v=o&jsessionid=#session.SessionID#','#theid#','left=20,top=20,width=500,height=500,toolbar=0,resizable=1,location=0,status=0,menubar=0,history=0');"><img src="#thestorage##path_to_asset#/#thethumb#" border="0" width="160"></a>
											</cfif>
										<cfelse>
