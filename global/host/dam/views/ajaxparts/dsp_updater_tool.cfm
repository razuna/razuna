			...
			<table border="0" width="100%" cellspacing="0" cellpadding="0" class="tablepanel">
				<tr>
					...
					<td width="70%" valign="top">
						...
						<p>
							Yes. The Razuna service itself was never affected as it was not a software errror. The Razuna service is now fully restored, including uploading files, will be handled normally going forward.
						</p>
						<h4>What have you done to prevent this from happening again?</h4>
						<p>
							Well, theoretically it wasn't supposed to happen the first time. We are absolutely shocked. In order to prevent this, we have implemented a double backup. I don't think there's a lot of companies with double backup, but that's what we've done.
						</p>
						<p>
							For performance reasons, we are still using a mirror with RAID 6, so a similar breakdown in one server, would not be noticeable. If two servers break down, we have a cloud backup with Amazon. So a similar, but still theoretically almost impossible, failure would mean that we would have down-time but files would be recoverable.
						</p>
					</td>
					<!--- App help link --->
