...
<cfoutput>
	<cfif session.hosttype EQ 0>
		#myFusebox.getApplicationData().defaults.trans("admin_upload_templates_intro")#<br><br>
		<cfinclude template="dsp_host_upgrade.cfm">
	<cfelse>
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="grid">
			<tr>
				<th colspan="4">
					<div style="float:right;"><a href="##" onclick="showwindow('#myself#c.upl_template_detail&upl_temp_id=0','#myFusebox.getApplicationData().defaults.trans("admin_upload_templates_new")#',650,1);">#myFusebox.getApplicationData().defaults.trans("admin_upload_templates_new")#</a></div>
				</th>
			</tr>
			<tr>
				<td colspan="4">#myFusebox.getApplicationData().defaults.trans("admin_upload_templates_intro")#</td>
			</tr>
		</table>
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="grid">
			<cfif qry_templates.recordcount NEQ 0>
				<tr>
					<th width="50%" nowrap="true">#myFusebox.getApplicationData().defaults.trans("admin_upload_templates")#</th>
