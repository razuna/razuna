...
<cfoutput>
	<cfif session.hosttype EQ 0>
		#myFusebox.getApplicationData().defaults.trans("customize_razuna")#<br><br>
	...
	<cfelse>
		...
		<div id="customization" class="collapsable">
			...
			<div id="logoimage" style="display:none;padding-top:10px;">
				...
				<table border="0" cellpadding="0" cellspacing="0" width="100%" class="grid">
					...
					<tr class="list">
						...
						<td valign="top" nowrap="nowrap">
							<a href="##" onclick="$('##loadlogo').load('#myself#ajax.prefs_loadlogo');return false;">#myFusebox.getApplicationData().defaults.trans("refresh")#</a> | <a href="##" onclick="$('##loadlogo').load('#myself#ajax.prefs_loadlogo&remove=t');">#myFusebox.getApplicationData().defaults.trans('remove_txt')#</a>
						</td>
					</tr>
				</table>
				<!--- Upload Login Image --->
				<table border="0" cellpadding="0" cellspacing="0" width="100%" class="grid">
					...
					<tr class="list">
						...
						<td valign="top" nowrap="nowrap">
							<a href="##" onclick="$('##loadloginimage').load('#myself#ajax.prefs_loadloginimg');return false;">#myFusebox.getApplicationData().defaults.trans("refresh")#</a> | <a href="##" onclick="$('##loadloginimage').load('#myself#ajax.prefs_loadloginimg&remove=t');">#myFusebox.getApplicationData().defaults.trans('remove_txt')#</a>
						</td>
					</tr>
				</table>
				...
				<table border="0" cellpadding="0" cellspacing="0" width="100%" class="grid">
					...
					<tr>
						...
						<td valign="top" nowrap="nowrap">
							<a href="##" onclick="$('##loadfaviconimage').load('#myself#ajax.prefs_loadfavicon');return false;">#myFusebox.getApplicationData().defaults.trans("refresh")#</a> | <a href="##" onclick="$('##loadfaviconimage').load('#myself#ajax.prefs_loadfavicon&remove=t');">#myFusebox.getApplicationData().defaults.trans('remove_txt')#</a>
						</td>
					</tr>
				</table>
			</div>
			...
			<div id="useroptions" style="display:none;padding-top:10px;">
				...
				<table border="0" cellpadding="0" cellspacing="0" width="100%" class="grid">
					<tr>
						<th>#myFusebox.getApplicationData().defaults.trans('user_options')#</th>
					</tr>
					<tr>
						<td>
			...
			<div stlye="clear:both;"><br /></div>
			<!--- Designs --->
			<a href="##" onclick="$('##designs').slideToggle('slow');$('.chzn4-select').chosen({search_contains: true});return false;"><div class="headers">#myFusebox.getApplicationData().defaults.trans('design')#</div></a>
			<div id="designs" style="display:none;padding-top:10px;">
				<!--- Design --->
				<table border="0" cellpadding="0" cellspacing="0" width="100%" class="grid">
					<tr>
						<th>#myFusebox.getApplicationData().defaults.trans('design')#</th>
					</tr>
					<tr class="list">
						<td>
							...
							<br />
							<select data-placeholder="#myFusebox.getApplicationData().defaults.trans("choose_group_user")#" class="chzn4-select" style="width:500px;" name="show_manage_part_slct" id="show_manage_part_slct" multiple="multiple">
							<option value=""></option>
				...
				<table border="0" cellpadding="0" cellspacing="0" width="100%" class="grid">
					...
					<strong>#myFusebox.getApplicationData().defaults.trans("header_customization_trash_icon")#</strong>
							...
							<br />
							<select data-placeholder="#myFusebox.getApplicationData().defaults.trans("choose_group_user")#" class="chzn4-select" style="width:500px;" name="show_trash_icon_slct" id="show_trash_icon_slct" multiple="multiple">
							<option value=""></option>
							<cfloop query="qry_groups">
			...
			<div stlye="clear:both;"><br /></div>
			<!--- Upload --->
			<a href="##" onclick="$('##uploadoptions').slideToggle('slow');return false;"><div class="headers">#myFusebox.getApplicationData().defaults.trans('upload')#</div></a>
			...
			<div stlye="clear:both;"><br /></div>
			<!--- Shared settings --->
			<a href="##" onclick="$('##sharedoptions').slideToggle('slow');return false;"><div class="headers">#myFusebox.getApplicationData().defaults.trans('shared_folder_collection')#</div></a>
			...
			<div stlye="clear:both;"><br /></div>
			<!--- Folder View --->
			<a href="##" onclick="$('##folderview').slideToggle('slow');$('.chzn3-select').chosen({search_contains: true});return false;"><div class="headers">#myFusebox.getApplicationData().defaults.trans('folder_view')#</div></a>
				...
				<table border="0" cellpadding="0" cellspacing="0" width="100%" class="grid">
					...
					<tr>
						<td>
							...
							<br /><br />
							<strong>#myFusebox.getApplicationData().defaults.trans('tabs')#</strong>
							<br /><br />
							...
							<br /><br />
							<strong>#myFusebox.getApplicationData().defaults.trans('icons')#</strong>
							<br /><br />
							<!--- Create Alias Icon --->
							...
							<br/>
							<select data-placeholder="#myFusebox.getApplicationData().defaults.trans("choose_group_user")#" class="chzn3-select" style="width:500px;" name="icon_alias_slct" id="icon_alias_slct" multiple="multiple">
							<option value=""></option>
							<cfloop query="qry_groups">
							...
							#myFusebox.getApplicationData().defaults.trans("folder_view_icon_desc")# 
							<br/>
							<select data-placeholder="#myFusebox.getApplicationData().defaults.trans("choose_group_user")#" class="chzn3-select" style="width:500px;" name="icon_move_slct" id="icon_move_slct" multiple="multiple">
							<option value=""></option>
							<cfloop query="qry_groups">
							...
							#myFusebox.getApplicationData().defaults.trans("folder_view_icon_desc")# 
							<br/>
							<select data-placeholder="#myFusebox.getApplicationData().defaults.trans("choose_group_user")#" class="chzn3-select" style="width:500px;" name="icon_batch_slct" id="icon_batch_slct" multiple="multiple">
							<option value=""></option>
							<cfloop query="qry_groups">
							...
							#myFusebox.getApplicationData().defaults.trans("folder_view_icon_desc")# 
							<br/>
							<select data-placeholder="#myFusebox.getApplicationData().defaults.trans("choose_group_user")#" class="chzn3-select" style="width:500px;" name="icon_metadata_export_slct" id="icon_metadata_export_slct" multiple="multiple">
							<option value=""></option>
							<cfloop query="qry_groups">
							...
							#myFusebox.getApplicationData().defaults.trans("folder_view_icon_desc")# 
							<br/>
							<select data-placeholder="#myFusebox.getApplicationData().defaults.trans("choose_group_user")#" class="chzn3-select" style="width:500px;" name="icon_metadata_import_slct" id="icon_metadata_import_slct" multiple="multiple">
							<option value=""></option>
							<cfloop query="qry_groups">
					...
					<tr>
						<td>
							<select name="images_metadata" multiple="multiple" style="width:400px;height:130px;">
								...
								<option value="img_id AS cs_img_id"<cfif listFind(qry_customization.images_metadata,"img_id AS cs_img_id")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('id')#</option>
								<option value="img_filename AS cs_img_filename"<cfif listFind(qry_customization.images_metadata,"img_filename AS cs_img_filename")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('file_name')#</option>
								<option value="img_description AS cs_img_description"<cfif listFind(qry_customization.images_metadata,"img_description AS cs_img_description")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('description')#</option>
								<option value="img_keywords AS cs_img_keywords"<cfif listFind(qry_customization.images_metadata,"img_keywords AS cs_img_keywords")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('keywords')#</option>
								<option value="img_create_time AS cs_img_create_time"<cfif listFind(qry_customization.images_metadata,"img_create_time AS cs_img_create_time")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('create_date')#</option>
								<option value="img_change_time AS cs_img_change_time"<cfif listFind(qry_customization.images_metadata,"img_change_time AS cs_img_change_time")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('change_date')#</option>
								<option value="img_width AS cs_img_width"<cfif listFind(qry_customization.images_metadata,"img_width AS cs_img_width")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('width')#</option>
								<option value="img_height AS cs_img_height"<cfif listFind(qry_customization.images_metadata,"img_height AS cs_img_height")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('heigth')#</option>
								<option value="img_size AS cs_img_size"<cfif listFind(qry_customization.images_metadata,"img_size AS cs_img_size")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('size')#</option>
								<option value="expiry_date AS cs_img_expiry_date"<cfif listFind(qry_customization.images_metadata,"expiry_date AS cs_img_expiry_date")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('expiry_date')#</option>
								<cfif prefs.set2_upc_enabled>
								<option value="img_upc_number AS cs_img_upc_number"<cfif listFind(qry_customization.images_metadata,"img_upc_number AS cs_img_upc_number")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('upc_number')#</'option>
								</cfif>
					...
					<tr>
						<td>
							<select name="videos_metadata" multiple="multiple" style="width:400px;height:130px;">
								<option value="">--- #myFusebox.getApplicationData().defaults.trans("standard_fields")# ---</option>
								<!--- Default values --->
								<option value="vid_id AS cs_vid_id"<cfif listFind(qry_customization.videos_metadata,"vid_id AS cs_vid_id")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('id')#</option>
								<option value="vid_filename AS cs_vid_filename"<cfif listFind(qry_customization.videos_metadata,"vid_filename AS cs_vid_filename")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('file_name')#</option>
								<option value="vid_description AS cs_vid_description"<cfif listFind(qry_customization.videos_metadata,"vid_description AS cs_vid_description")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('description')#</option>
								<option value="vid_keywords AS cs_vid_keywords"<cfif listFind(qry_customization.videos_metadata,"vid_keywords AS cs_vid_keywords")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('keywords')#</option>
								<option value="vid_create_time AS cs_vid_create_time"<cfif listFind(qry_customization.videos_metadata,"vid_create_time AS cs_vid_create_time")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('create_date')#</option>
								<option value="vid_change_time AS cs_vid_change_time"<cfif listFind(qry_customization.videos_metadata,"vid_change_time AS cs_vid_change_time")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('change_date')#</option>
								<option value="vid_width AS cs_vid_width"<cfif listFind(qry_customization.videos_metadata,"vid_width AS cs_vid_width")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('width')#</option>
								<option value="vid_height AS cs_vid_height"<cfif listFind(qry_customization.videos_metadata,"vid_height AS cs_vid_height")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('heigth')#</option>
								<option value="vid_size AS cs_vid_size"<cfif listFind(qry_customization.videos_metadata,"vid_size AS cs_vid_size")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('size')#</option>
								<option value="expiry_date AS cs_vid_expiry_date"<cfif listFind(qry_customization.images_metadata,"expiry_date AS cs_vid_expiry_date")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('expiry_date')#</option>
								<cfif prefs.set2_upc_enabled>
								<option value="vid_upc_number AS cs_vid_upc_number"<cfif listFind(qry_customization.videos_metadata,"vid_upc_number AS cs_vid_upc_number")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('upc_number')#</option>
								</cfif>
							</select>
						</td>
						<td>
					...
					<tr>
						<td>
							<select name="files_metadata" multiple="multiple" style="width:400px;height:130px;">
								<!--- Default values --->
								<option value="">--- #myFusebox.getApplicationData().defaults.trans("standard_fields")# ---</option>
								<option value="file_id AS cs_file_id"<cfif listFind(qry_customization.files_metadata,"file_id AS cs_file_id")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('id')#</option>
								<option value="file_name AS cs_file_filename"<cfif listFind(qry_customization.files_metadata,"file_name AS cs_file_filename")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('file_name')#</option>
								<option value="file_desc AS cs_file_description"<cfif listFind(qry_customization.files_metadata,"file_desc AS cs_file_description")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('description')#</option>
								<option value="file_keywords AS cs_file_keywords"<cfif listFind(qry_customization.files_metadata,"file_keywords AS cs_file_keywords")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('keywords')#</option>
								<option value="file_create_time AS cs_file_create_time"<cfif listFind(qry_customization.files_metadata,"file_create_time AS cs_file_create_time")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('create_date')#</option>
								<option value="file_change_time AS cs_file_change_time"<cfif listFind(qry_customization.files_metadata,"file_change_time AS cs_file_change_time")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('change_date')#</option>
								<option value="file_size AS cs_file_size"<cfif listFind(qry_customization.files_metadata,"file_size AS cs_file_size")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('size')#</option>
								<option value="expiry_date AS cs_file_expiry_date"<cfif listFind(qry_customization.images_metadata,"expiry_date AS cs_file_expiry_date")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('expiry_date')#</option>
								<cfif prefs.set2_upc_enabled>
								<option value="file_upc_number AS cs_file_upc_number"<cfif listFind(qry_customization.files_metadata,"file_upc_number AS cs_file_upc_number")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('upc_number')#</option>
								</cfif>
								<option value="">--- #myFusebox.getApplicationData().defaults.trans("extended_metadata")# ---</option>
					...
					<tr>
						<td>
							<select name="audios_metadata" multiple="multiple" style="width:400px;height:130px;">
								<option value="">--- #myFusebox.getApplicationData().defaults.trans("standard_fields")# ---</option>
								<!--- Default values --->
								<option value="aud_id AS cs_aud_id"<cfif listFind(qry_customization.audios_metadata,"aud_id AS cs_aud_id")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('id')#</option>
								<option value="aud_name AS cs_aud_filename"<cfif listFind(qry_customization.audios_metadata,"aud_name AS cs_aud_filename")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('file_name')#</option>
								<option value="aud_description AS cs_aud_description"<cfif listFind(qry_customization.audios_metadata,"aud_description AS cs_aud_description")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('description')#</option>
								<option value="aud_keywords AS cs_aud_keywords"<cfif listFind(qry_customization.audios_metadata,"aud_keywords AS cs_aud_keywords")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('keywords')#</option>
								<option value="aud_create_time AS cs_aud_create_time"<cfif listFind(qry_customization.audios_metadata,"aud_create_time AS cs_aud_create_time")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('create_date')#</option>
								<option value="aud_change_time AS cs_aud_change_time"<cfif listFind(qry_customization.audios_metadata,"aud_change_time AS cs_aud_change_time")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('change_date')#</option>
								<option value="aud_size AS cs_aud_size"<cfif listFind(qry_customization.audios_metadata,"aud_size AS cs_aud_size")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('size')#</option>
								<option value="expiry_date AS cs_aud_expiry_date"<cfif listFind(qry_customization.images_metadata,"expiry_date AS cs_aud_expiry_date")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('expiry_date')#</option>
								<cfif prefs.set2_upc_enabled>
								<option value="aud_upc_number AS cs_aud_upc_number"<cfif listFind(qry_customization.audios_metadata,"aud_upc_number AS cs_aud_upc_number")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('upc_number')#</option>
								</cfif>
							</select>
						</td>
						<td>
					...
					<tr>
						<td>
							<select name="images_metadata_top" multiple="multiple" style="width:400px;height:130px;">
								<!--- Default values --->
								<option value="">--- #myFusebox.getApplicationData().defaults.trans("standard_fields")# ---</option>
								<option value="img_id AS cs_img_id"<cfif listFind(qry_customization.images_metadata_top,"img_id AS cs_img_id")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('id')#</option>
								<option value="img_filename AS cs_img_filename"<cfif listFind(qry_customization.images_metadata_top,"img_filename AS cs_img_filename")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('file_name')#</option>
								<option value="img_description AS cs_img_description"<cfif listFind(qry_customization.images_metadata_top,"img_description AS cs_img_description")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('description')#</option>
								<option value="img_keywords AS cs_img_keywords"<cfif listFind(qry_customization.images_metadata_top,"img_keywords AS cs_img_keywords")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('keywords')#</option>
								<option value="img_create_time AS cs_img_create_time"<cfif listFind(qry_customization.images_metadata_top,"img_create_time AS cs_img_create_time")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('create_date')#</option>
								<option value="img_change_time AS cs_img_change_time"<cfif listFind(qry_customization.images_metadata_top,"img_change_time AS cs_img_change_time")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('change_date')#</option>
								<option value="img_width AS cs_img_width"<cfif listFind(qry_customization.images_metadata_top,"img_width AS cs_img_width")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('width')#</option>
								<option value="img_height AS cs_img_height"<cfif listFind(qry_customization.images_metadata_top,"img_height AS cs_img_height")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('heigth')#</option>
								<option value="img_size AS cs_img_size"<cfif listFind(qry_customization.images_metadata_top,"img_size AS cs_img_size")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('size')#</option>
								<option value="expiry_date AS cs_img_expiry_date"<cfif listFind(qry_customization.images_metadata_top,"expiry_date AS cs_img_expiry_date")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('expiry_date')#</option>
								<cfif prefs.set2_upc_enabled>
								<option value="img_upc_number AS cs_img_upc_number"<cfif listFind(qry_customization.images_metadata_top,"img_upc_number AS cs_img_upc_number")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('upc_number')#</option>
								</cfif>
								<option value="">--- #myFusebox.getApplicationData().defaults.trans("extended_metadata")# ---</option>
								<cfloop list="#attributes.meta_img#" index="i">
									<!--- Upper case the first char --->
					...
					<tr>
						<td>
							<select name="videos_metadata_top" multiple="multiple" style="width:400px;height:130px;">
								<option value="">--- #myFusebox.getApplicationData().defaults.trans("standard_fields")# ---</option>
								<!--- Default values --->
								<option value="vid_id AS cs_vid_id"<cfif listFind(qry_customization.videos_metadata_top,"vid_id AS cs_vid_id")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('id')#</option>
								<option value="vid_filename AS cs_vid_filename"<cfif listFind(qry_customization.videos_metadata_top,"vid_filename AS cs_vid_filename")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('file_name')#</option>
								<option value="vid_description AS cs_vid_description"<cfif listFind(qry_customization.videos_metadata_top,"vid_description AS cs_vid_description")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('description')#</option>
								<option value="vid_keywords AS cs_vid_keywords"<cfif listFind(qry_customization.videos_metadata_top,"vid_keywords AS cs_vid_keywords")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('keywords')#</option>
								<option value="vid_create_time AS cs_vid_create_time"<cfif listFind(qry_customization.videos_metadata_top,"vid_create_time AS cs_vid_create_time")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('create_date')#</option>
								<option value="vid_change_time AS cs_vid_change_time"<cfif listFind(qry_customization.videos_metadata_top,"vid_change_time AS cs_vid_change_time")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('change_date')#</option>
								<option value="vid_width AS cs_vid_width"<cfif listFind(qry_customization.videos_metadata_top,"vid_width AS cs_vid_width")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('width')#</option>
								<option value="vid_height AS cs_vid_height"<cfif listFind(qry_customization.videos_metadata_top,"vid_height AS cs_vid_height")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('heigth')#</option>
								<option value="vid_size AS cs_vid_size"<cfif listFind(qry_customization.videos_metadata_top,"vid_size AS cs_vid_size")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('size')#</option>
								<option value="expiry_date AS cs_vid_expiry_date"<cfif listFind(qry_customization.images_metadata_top,"expiry_date AS cs_vid_expiry_date")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('expiry_date')#</option>
								<cfif prefs.set2_upc_enabled>
								<option value="vid_upc_number AS cs_vid_upc_number"<cfif listFind(qry_customization.videos_metadata_top,"vid_upc_number AS cs_vid_upc_number")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('upc_number')#</option>
								</cfif>
							</select>
						</td>
						<td>
					...
					<tr>
						<td>
							<select name="files_metadata_top" multiple="multiple" style="width:400px;height:130px;">
								<!--- Default values --->
								<option value="">--- #myFusebox.getApplicationData().defaults.trans("standard_fields")# ---</option>
								<option value="file_id AS cs_file_id"<cfif listFind(qry_customization.files_metadata_top,"file_id AS cs_file_id")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('id')#</option>
								<option value="file_name AS cs_file_filename"<cfif listFind(qry_customization.files_metadata_top,"file_name AS cs_file_filename")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('file_name')#</option>
								<option value="file_desc AS cs_file_description"<cfif listFind(qry_customization.files_metadata_top,"file_desc AS cs_file_description")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('description')#</option>
								<option value="file_keywords AS cs_file_keywords"<cfif listFind(qry_customization.files_metadata_top,"file_keywords AS cs_file_keywords")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('keywords')#</option>
								<option value="file_create_time AS cs_file_create_time"<cfif listFind(qry_customization.files_metadata_top,"file_create_time AS cs_file_create_time")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('create_date')#</option>
								<option value="file_change_time AS cs_file_change_time"<cfif listFind(qry_customization.files_metadata_top,"file_change_time AS cs_file_change_time")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('change_date')#</option>
								<option value="file_size AS cs_file_size"<cfif listFind(qry_customization.files_metadata_top,"file_size AS cs_file_size")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('size')#</option>
								<option value="expiry_date AS cs_file_expiry_date"<cfif listFind(qry_customization.images_metadata_top,"expiry_date AS cs_file_expiry_date")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('expiry_date')#</option>
								<cfif prefs.set2_upc_enabled>
								<option value="file_upc_number AS cs_file_upc_number"<cfif listFind(qry_customization.files_metadata_top,"file_upc_number AS cs_file_upc_number")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('upc_number')#</option>
								</cfif>
								<option value="">--- #myFusebox.getApplicationData().defaults.trans("extended_metadata")# ---</option>
								<cfloop list="#attributes.meta_doc#" index="i">
									<!--- Upper case the first char --->
					...
					<tr>
						<td>
							<select name="audios_metadata_top" multiple="multiple" style="width:400px;height:130px;">
								<option value="">--- #myFusebox.getApplicationData().defaults.trans("standard_fields")# ---</option>
								<!--- Default values --->
								<option value="aud_id AS cs_aud_id"<cfif listFind(qry_customization.audios_metadata_top,"aud_id AS cs_aud_id")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('id')#</option>
								<option value="aud_name AS cs_aud_filename"<cfif listFind(qry_customization.audios_metadata_top,"aud_name AS cs_aud_filename")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('file_name')#</option>
								<option value="aud_description AS cs_aud_description"<cfif listFind(qry_customization.audios_metadata_top,"aud_description AS cs_aud_description")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('description')#</option>
								<option value="aud_keywords AS cs_aud_keywords"<cfif listFind(qry_customization.audios_metadata_top,"aud_keywords AS cs_aud_keywords")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('keywords')#</option>
								<option value="aud_create_time AS cs_aud_create_time"<cfif listFind(qry_customization.audios_metadata_top,"aud_create_time AS cs_aud_create_time")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('create_date')#</option>
								<option value="aud_change_time AS cs_aud_change_time"<cfif listFind(qry_customization.audios_metadata_top,"aud_change_time AS cs_aud_change_time")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('change_date')#</option>
								<option value="aud_size AS cs_aud_size"<cfif listFind(qry_customization.audios_metadata_top,"aud_size AS cs_aud_size")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('size')#</option>
								<option value="expiry_date AS cs_aud_expiry_date"<cfif listFind(qry_customization.images_metadata_top,"expiry_date AS cs_aud_expiry_date")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('expiry_date')#</option>
								<cfif prefs.set2_upc_enabled>
								<option value="aud_upc_number AS cs_aud_upc_number"<cfif listFind(qry_customization.audios_metadata_top,"aud_upc_number AS cs_aud_upc_number")> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans('upc_number')#</option>
								</cfif>
							</select>
						</td>
						<td>
					...
					<tr>
						<td>
							...
							<div>
								...
								<select data-placeholder="#myFusebox.getApplicationData().defaults.trans("choose_group_user")#" class="chzn2-select" style="width:500px;" name="btn_email_slct" id="btn_email_slct" multiple="multiple">
								<option value=""></option>
								<cfloop query="qry_groups">
							...
							<div><input type="radio" name="button_send_ftp" value="true"<cfif qry_customization.button_send_ftp> checked="checked"</cfif> />#myFusebox.getApplicationData().defaults.trans("show")# <input type="radio" name="button_send_ftp" value="false"<cfif !qry_customization.button_send_ftp> checked="checked"</cfif> />#myFusebox.getApplicationData().defaults.trans("hide")#
								...
								<select data-placeholder="#myFusebox.getApplicationData().defaults.trans("choose_group_user")#" class="chzn2-select" style="width:500px;" name="btn_ftp_slct" id="btn_ftp_slct" multiple="multiple">
								<option value=""></option>
								<cfloop query="qry_groups">
							...
							<div><input type="radio" name="button_basket" value="true"<cfif qry_customization.button_basket> checked="checked"</cfif> />#myFusebox.getApplicationData().defaults.trans("show")# <input type="radio" name="button_basket" value="false"<cfif !qry_customization.button_basket> checked="checked"</cfif> />#myFusebox.getApplicationData().defaults.trans("hide")#
								...
								#myFusebox.getApplicationData().defaults.trans("file_detail_btn_desc")# 
								<br/>
								<select data-placeholder="#myFusebox.getApplicationData().defaults.trans("choose_group_user")#" class="chzn2-select" style="width:500px;" name="btn_basket_slct" id="btn_basket_slct" multiple="multiple">
								<option value=""></option>
								<cfloop query="qry_groups">
							...
							<div><input type="radio" name="button_add_to_collection" value="true"<cfif qry_customization.button_add_to_collection> checked="checked"</cfif> />#myFusebox.getApplicationData().defaults.trans("show")# <input type="radio" name="button_add_to_collection" value="false"<cfif !qry_customization.button_add_to_collection> checked="checked"</cfif> />#myFusebox.getApplicationData().defaults.trans("hide")#
								...
								<select data-placeholder="#myFusebox.getApplicationData().defaults.trans("choose_group_user")#" class="chzn2-select" style="width:500px;" name="btn_collection_slct" id="btn_collection_slct" multiple="multiple">
								<option value=""></option>
								<cfloop query="qry_groups">
							...
							<div><input type="radio" name="button_print" value="true"<cfif qry_customization.button_print> checked="checked"</cfif> />#myFusebox.getApplicationData().defaults.trans("show")# <input type="radio" name="button_print" value="false"<cfif !qry_customization.button_print> checked="checked"</cfif> />#myFusebox.getApplicationData().defaults.trans("hide")#
								...
								<select data-placeholder="#myFusebox.getApplicationData().defaults.trans("choose_group_user")#" class="chzn2-select" style="width:500px;" name="btn_print_slct" id="btn_print_slct" multiple="multiple">
								<option value=""></option>
								<cfloop query="qry_groups">
			...
			<div id="basketview" style="display:none;padding-top:10px;">
				...
				<table border="0">
					<tr>
						...
						<td>
							<select data-placeholder="#myFusebox.getApplicationData().defaults.trans("choose_group_user")#" class="chzn-select" style="width:500px;" name="publish_btn_basket" id="publish_btn_basket" multiple="multiple">
								<option value=""></option>
								<cfloop query="qry_groups">
					...
					<tr>
						...
						<td>
							<select data-placeholder="#myFusebox.getApplicationData().defaults.trans("choose_group_user")#" class="chzn-select" style="width:500px;" name="email_btn_basket" id="email_btn_basket" multiple="multiple">
								<option value=""></option>
								<cfloop query="qry_groups">
					...
					<tr>
						...
						<td>
							<select data-placeholder="#myFusebox.getApplicationData().defaults.trans("choose_group_user")#" class="chzn-select" style="width:500px;" name="ftp_btn_basket" id="ftp_btn_basket" multiple="multiple">
								<option value=""></option>
								<cfloop query="qry_groups">
					...
					<tr>
						...
						<td>
							<select data-placeholder="#myFusebox.getApplicationData().defaults.trans("choose_group_user")#" class="chzn-select" style="width:500px;" name="metadata_btn_basket" id="metadata_btn_basket" multiple="multiple">
								<option value=""></option>
								<cfloop query="qry_groups">
