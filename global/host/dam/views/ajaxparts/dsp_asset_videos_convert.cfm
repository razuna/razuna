						...
						<cfelse>
							...
							<div id="divo#attributes.file_id#" style="display:none;">
								...
								<cfif application.razuna.storage EQ "local">
									<input type="text" id="inputo#attributes.file_id#d" style="width:100%;" value="http://#cgi.http_host##dynpath#/assets/#session.hostid#/#qry_detail.detail.path_to_asset#/#qry_detail.detail.vid_name_org#" />
								<cfelse>
