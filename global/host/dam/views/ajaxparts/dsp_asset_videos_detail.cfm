			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				...
				<tr>
					...
					<td nowrap="true" valign="top" align="center" style="padding-top:20px;">
						<cfif attributes.folderaccess NEQ "R" OR (org_share_setting.recordcount EQ 1 AND org_share_setting.asset_dl EQ 1)>
							<cfif qry_detail.detail.link_kind NEQ "lan">
								<div id="thevideodetail">
									...
									<cfelse>
										<a href="#session.thehttp##cgi.HTTP_HOST##cgi.SCRIPT_NAME#?#theaction#=c.sv&f=#attributes.file_id#&v=o" target="_blank"><img src="<cfif application.razuna.storage EQ "local">#cgi.context_path#/assets/#session.hostid#/#qry_detail.detail.path_to_asset#/#qry_detail.detail.vid_name_image#?_v=#qry_detail.detail.hashtag#<cfelse>#qry_detail.detail.cloud_url#</cfif>" width="400"></a>
									</cfif>
								</div>
							<cfelse>
						...
						<cfelse>
							<img src="#thestorage##qry_detail.detail.path_to_asset#/#qry_detail.detail.vid_name_image#" border="0" width="400">
						</cfif>
					</td>
				<cfif qry_detail.detail.link_kind EQ "url">
					</tr>
					...
					<td width="1%" valign="top" style="padding-top:20px;">
						<table border="0" width="100%" cellpadding="0" cellspacing="0" class="grid">
							...
							<tr>
								...
								<td width="1%" nowrap="true">#dateformat(qry_detail.detail.vid_create_time, "#myFusebox.getApplicationData().defaults.getdateformat(thestruct=attributes)#")#</td>
							</tr>
							<tr>
								<td width="1%" nowrap="true" valign="top">#myFusebox.getApplicationData().defaults.trans("date_changed")#</td>
								<td width="1%" nowrap="true" valign="top">#dateformat(qry_detail.detail.vid_change_time, "#myFusebox.getApplicationData().defaults.getdateformat(thestruct=attributes)#")#</td>
							</tr>
							<tr>
