				...
				<tr>
					<td width="100%" nowrap="true" colspan="2">
						...
						<cfif #session.folderaccess# EQ "X">
							...
							<input type="button" name="remove" value="#defaultsObj.trans("delete_asset")#" class="button" onclick="showwindow('#myself#ajax.remove_record&id=#attributes.file_id#&what=videos&loaddiv=#loaddiv#&folder_id=#folder_id#&offset=#attributes.offset#&rowmaxpage=#attributes.rowmaxpage#&showsubfolders=#session.showsubfolders#','#defaultsObj.trans("remove")#',400,2);return false;"> 
						</cfif>
