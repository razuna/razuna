	...
	<div id="searchadvanced">
			...
			<form name="advsearch_all" id="advsearch_all" method="post" onsubmit="searchadv_all('advsearch_all','c.search_simple','#attributes.folder_id#');return false;">
				<table border="0" cellpadding="0" cellspacing="0" width="100%" class="grid">
					...
					<tr>
						...
						<td><select name="on_day" class="text"><option value="">#myFusebox.getApplicationData().defaults.trans("day")#</option><cfloop from="01" to="31" index="theday"><option value="<cfif len(theday) EQ 1>0</cfif>#theday#">#theday#</option></cfloop></select> <select name="on_month" class="text"><option value="">#myFusebox.getApplicationData().defaults.trans("month")#</option><cfloop from="01" to="12" index="themonth"><option value="<cfif len(themonth) EQ 1>0</cfif>#themonth#">#themonth#</option></cfloop></select> <select name="on_year" class="text"><option value="">#myFusebox.getApplicationData().defaults.trans("year")#</option><cfloop from="#lastyear#" to="#newyear#" index="theyear"><option value="#theyear#">#theyear#</option></cfloop></select> <a href="##" onclick="settoday('advsearch_all');">#myFusebox.getApplicationData().defaults.trans("today")#</a></td>
					</tr>
					<tr>
						<td>And/Or</td>
						<td>
		...
		<div id="adv_files">
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%" class="grid">
				...
				<tr>
					<td nowrap="true">#myFusebox.getApplicationData().defaults.trans("date_created")#</td>
					<td><select name="on_day" class="text"><option value="">#myFusebox.getApplicationData().defaults.trans("day")#</option><cfloop from="1" to="31" index="theday"><option value="<cfif len(theday) EQ 1>0</cfif>#theday#">#theday#</option></cfloop></select> <select name="on_month" class="text"><option value="">#myFusebox.getApplicationData().defaults.trans("month")#</option><cfloop from="01" to="12" index="themonth"><option value="<cfif len(themonth) EQ 1>0</cfif>#themonth#">#themonth#</option></cfloop></select> <select name="on_year" class="text"><option value="">#myFusebox.getApplicationData().defaults.trans("year")#</option><cfloop from="#lastyear#" to="#newyear#" index="theyear"><option value="#theyear#">#theyear#</option></cfloop></select> <a href="##" onclick="settoday('advsearch_files');">#myFusebox.getApplicationData().defaults.trans("today")#</a></td>
				</tr>
				<tr>
					<td>And/Or</td>
					<td>
		...
		<div id="adv_images">
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%" class="grid">
				...
				<tr>
					<td nowrap="true">#myFusebox.getApplicationData().defaults.trans("date_created")#</td>
					<td><select name="on_day" class="text"><option value="">#myFusebox.getApplicationData().defaults.trans("day")#</option><cfloop from="1" to="31" index="theday"><option value="<cfif len(theday) EQ 1>0</cfif>#theday#">#theday#</option></cfloop></select> <select name="on_month" class="text"><option value="">#myFusebox.getApplicationData().defaults.trans("month")#</option><cfloop from="01" to="12" index="themonth"><option value="<cfif len(themonth) EQ 1>0</cfif>#themonth#">#themonth#</option></cfloop></select> <select name="on_year" class="text"><option value="">#myFusebox.getApplicationData().defaults.trans("year")#</option><cfloop from="#lastyear#" to="#newyear#" index="theyear"><option value="#theyear#">#theyear#</option></cfloop></select> <a href="##" onclick="settoday('advsearch_images');">#myFusebox.getApplicationData().defaults.trans("today")#</a></td>
				</tr>
				<tr>
					<td>And/Or</td>
					<td>
		...
		<div id="adv_videos">
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%" class="grid">
				...
				<tr>
					<td nowrap="true">#myFusebox.getApplicationData().defaults.trans("date_created")#</td>
					<td><select name="on_day" class="text"><option value="">#myFusebox.getApplicationData().defaults.trans("day")#</option><cfloop from="1" to="31" index="theday"><option value="<cfif len(theday) EQ 1>0</cfif>#theday#">#theday#</option></cfloop></select> <select name="on_month" class="text"><option value="">#myFusebox.getApplicationData().defaults.trans("month")#</option><cfloop from="01" to="12" index="themonth"><option value="<cfif len(themonth) EQ 1>0</cfif>#themonth#">#themonth#</option></cfloop></select> <select name="on_year" class="text"><option value="">#myFusebox.getApplicationData().defaults.trans("year")#</option><cfloop from="#lastyear#" to="#newyear#" index="theyear"><option value="#theyear#">#theyear#</option></cfloop></select> <a href="##" onclick="settoday('advsearch_videos');">#myFusebox.getApplicationData().defaults.trans("today")#</a></td>
				</tr>
				<tr>
					<td>And/Or</td>
					<td>
		...
		<div id="adv_audios">
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%" class="grid">
				...
				<tr>
					<td nowrap="true">#myFusebox.getApplicationData().defaults.trans("date_created")#</td>
					<td><select name="on_day" class="text"><option value="">#myFusebox.getApplicationData().defaults.trans("day")#</option><cfloop from="1" to="31" index="theday"><option value="<cfif len(theday) EQ 1>0</cfif>#theday#">#theday#</option></cfloop></select> <select name="on_month" class="text"><option value="">#myFusebox.getApplicationData().defaults.trans("month")#</option><cfloop from="01" to="12" index="themonth"><option value="<cfif len(themonth) EQ 1>0</cfif>#themonth#">#themonth#</option></cfloop></select> <select name="on_year" class="text"><option value="">#myFusebox.getApplicationData().defaults.trans("year")#</option><cfloop from="#lastyear#" to="#newyear#" index="theyear"><option value="#theyear#">#theyear#</option></cfloop></select> <a href="##" onclick="settoday('advsearch_audios');">#myFusebox.getApplicationData().defaults.trans("today")#</a></td>
				</tr>
				<tr>
					<td>And/Or</td>
					<td>
