...
<cfoutput>
	<table border="0" cellpadding="0" cellspacing="0" width="100%" class="grid">
		<tr>
			<td class="td2" nowrap="nowrap"><strong>#myFusebox.getApplicationData().defaults.trans("document_title")#</strong></td>
		...
		<tr>
			<td class="td2" nowrap="nowrap"><strong>#myFusebox.getApplicationData().defaults.trans("plugin_author")#</strong></td>
		...
		<tr>
			<td class="td2" nowrap="nowrap"><strong>#myFusebox.getApplicationData().defaults.trans("author_title")#</strong></td>
		...
		<tr>
			<td class="td2" nowrap="nowrap"><strong>#myFusebox.getApplicationData().defaults.trans("copyright_status")#</strong></td>
			<td class="td2"><select name="xmp_copyright_status">
			<option value=""<cfif qry_xmp.copystatus EQ ""> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans("unknown")#</option>
			<option value="true"<cfif qry_xmp.copystatus EQ "true"> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans("copyrighted")#</option>
			<option value="false"<cfif qry_xmp.copystatus EQ "false"> selected="selected"</cfif>>#myFusebox.getApplicationData().defaults.trans("public_domain")#</option>
			</select></td>
		</tr>
		<tr>
			<td class="td2" nowrap="nowrap" valign="top"><strong>#myFusebox.getApplicationData().defaults.trans("copyright_notice")#</strong></td>
		...
		<tr>
			<td class="td2" nowrap="nowrap"><strong>#myFusebox.getApplicationData().defaults.trans("copyright_info_url")#</strong></td>
