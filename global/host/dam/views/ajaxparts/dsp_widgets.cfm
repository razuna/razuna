			...
			<cfelse>
				...
				<cfloop query="qry_widgets">
					<tr class="list">
						...
						<td valign="top"><a href="#session.thehttp##cgi.http_host##cgi.script_name#?fa=c.w&wid=#widget_id#" target="_blank">#myFusebox.getApplicationData().defaults.trans("show_widget")#</a></td>
						<!--- trash --->
