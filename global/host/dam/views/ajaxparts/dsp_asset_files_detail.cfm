										...
										<tr>
											<td colspan="2">
												<cfif attributes.folderaccess EQ "R">
													...
													<cfif application.razuna.storage NEQ "amazon" AND qry_detail.detail.file_extension EQ "PDF" AND qry_detail.detail.link_kind NEQ "url"><a href="#variables.thehttp##cgi.HTTP_HOST##cgi.SCRIPT_NAME#?#theaction#=c.sp&f=#file_id#" target="_blank">PDF as image(s)</a>
													</cfif>
												<cfelse>
													<cfif qry_detail.detail.link_kind NEQ "url">
														<strong>Original</strong><br />
														<cfif qry_detail.detail.shared EQ "F"><a href="#variables.thehttp##cgi.HTTP_HOST##cgi.SCRIPT_NAME#?#theaction#=c.sf&f=#attributes.file_id#" target="_blank"><cfelse><a href="#application.razuna.nvxurlservices#/razuna/#session.hostid#/#qry_detail.detail.path_to_asset#/#qry_detail.detail.file_name_org#" target="_blank"></cfif>View</a> | <a href="#myself#c.serve_file&file_id=#attributes.file_id#&type=doc" target="_blank">Download</a> | 
														...
														<div id="divo#attributes.file_id#" style="display:none;width:450px;">
															<input type="text" id="inputo#attributes.file_id#" style="width:100%;" value="#variables.thehttp##cgi.http_host##cgi.script_name#?#theaction#=c.sf&f=#attributes.file_id#&v=o" />
															<!--- Plugin --->
