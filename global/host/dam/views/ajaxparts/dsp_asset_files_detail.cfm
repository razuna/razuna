				...
				<tr>
					<td colspan="2">
						...
						<cfif #session.folderaccess# EQ "X">
							...
							<input type="button" name="remove" value="#defaultsObj.trans("delete_asset")#" class="button" onclick="showwindow('#myself#ajax.remove_record&id=#file_id#&what=files&loaddiv=#loaddiv#&folder_id=#folder_id#&offset=#attributes.offset#&rowmaxpage=#attributes.rowmaxpage#&showsubfolders=#session.showsubfolders#','#defaultsObj.trans("remove")#',400,2);return false;">
						</cfif>
...
<script language="JavaScript" type="text/javascript">
	...
	raztagit('tags_doc','#attributes.file_id#','doc',raztags,'#settingsobj.get_label_set().set2_labels_users#');
</script>
</cfoutput>