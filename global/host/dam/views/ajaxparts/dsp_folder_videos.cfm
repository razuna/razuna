					...
					<td>
						<div class="grid-masonry" id="selectme">
							...
							<cfloop query="qry_files">
								...
								<div class="assetbox grid-masonry-item" id="#id#-vid#iif(attributes.folder_id NEQ folder_id_r,de('_alias'),de(''))#">
									<cfif is_available>
										...
										<cfloop list="#attributes.cs_place.top.video#" index="m" delimiters=",">
											...
											<cfif m CONTAINS "_filename">
												<a href="##" onclick="showwindow('#myself##xfa.assetdetail#&file_id=#vid_id#&what=videos&loaddiv=#kind#&folder_id=#folder_id#&showsubfolders=#attributes.showsubfolders#&row=#mycurrentRow#&filecount=#attributes.qry_filecount#','',1000,1);return false;"><strong>#left(evaluate(listlast(m," ")),150)#</strong></a>
										...
										<br/><br/>
										<a href="##" onclick="showwindow('#myself##xfa.assetdetail#&file_id=#vid_id#&what=videos&loaddiv=#kind#&folder_id=#folder_id#&showsubfolders=#attributes.showsubfolders#&row=#mycurrentRow#&filecount=#attributes.qry_filecount#','',1000,1);return false;">
										...
										<cfif attributes.cs.videos_metadata EQ "">
											<a href="##" onclick="showwindow('#myself##xfa.assetdetail#&file_id=#vid_id#&what=videos&loaddiv=#kind#&folder_id=#folder_id#&showsubfolders=#attributes.showsubfolders#&row=#mycurrentRow#&filecount=#attributes.qry_filecount#','',1000,1);return false;"><strong>#left(vid_filename,50)#</strong></a>
										<cfelse>
											<br />
									...
									<cfelse>
										...
										#dateformat(vid_create_time, "#myFusebox.getApplicationData().defaults.getdateformat(thestruct=attributes)#")# #timeformat(vid_create_time, "HH:mm")#
										<br><br>
				...
				<cfloop query="qry_files">
					...
					<tr class="list thumbview">
						...
						<td width="100%" valign="top">
							<a href="##" onclick="showwindow('#myself##xfa.assetdetail#&file_id=#vid_id#&what=videos&loaddiv=#kind#&folder_id=#folder_id#&showsubfolders=#attributes.showsubfolders#&row=#mycurrentRow#&filecount=#attributes.qry_filecount#','',1000,1);return false;"><strong>#vid_filename#</strong></a>
							<br />
							<!--- Icons --->
						...
						<td nowrap="true" width="1%" align="center" valign="top">#dateformat(vid_create_time, "#myFusebox.getApplicationData().defaults.getdateformat(thestruct=attributes)#")#</td>
						<td nowrap="true" width="1%" align="center" valign="top">#dateformat(vid_change_time, "#myFusebox.getApplicationData().defaults.getdateformat(thestruct=attributes)#")#</td>
					</tr>
				</cfloop>
			</cfif>
			<!--- Icon Bar --->
