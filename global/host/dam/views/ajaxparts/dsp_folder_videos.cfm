				...
				<tr>
					<td id="selectme">
						...
						<cfloop query="qry_files">
							...
							<div class="assetbox" style="<cfif cs.assetbox_width NEQ "">width:#cs.assetbox_width#px;</cfif><cfif cs.assetbox_height NEQ "">min-height:#cs.assetbox_height#px;</cfif>" id="#id#-vid#iif(attributes.folder_id NEQ folder_id_r,de('_alias'),de(''))#">
								<cfif is_available>
