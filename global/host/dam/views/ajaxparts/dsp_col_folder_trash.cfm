				...
				<tr>
					<td colspan="6" style="border:0px;">
						<div id="folderselectionallform_folders" class="actiondropdown">
							...
							<a href="##" onclick="showwindow('#myself#ajax.remove_folder&what=selected_col_folder&loaddiv=collection&fromtrash=true','#Jsstringformat(myFusebox.getApplicationData().defaults.trans("remove"))#',400,1);return false;" title="#myFusebox.getApplicationData().defaults.trans("remove")#">
								<div style="float:left;">
