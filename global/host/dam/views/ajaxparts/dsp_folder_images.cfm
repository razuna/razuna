					...
					<td valign="top" width="1%" nowrap="true">
						...
						<div style="padding-top:5px;width:130px;white-space:nowrap;">
							<div style="float:left;">
								<input type="checkbox" name="file_id" value="#img_id#-aud" onclick="enablesub('allform');"<cfif listfindnocase(session.file_id,"#img_id#-aud") NEQ 0> checked="checked"</cfif>>
							</div>
							<div style="float:right;padding-top:2px;">
								<a href="##" onclick="showwindow('#myself#c.widget_download&file_id=#img_id#&kind=aud','#JSStringFormat(myFusebox.getApplicationData().defaults.trans("download"))#',650,1);return false;"><img src="#dynpath#/global/host/dam/images/go-down.png" width="16" height="16" border="0" /></a>
				...
				<tr class="list thumbview">
					...
					<td width="100%" valign="top">
						...
						<div style="float:left;padding-top:5px;">
							<input type="checkbox" name="file_id" value="#img_id#-img" onclick="enablesub('allform');"<cfif listfindnocase(session.file_id,"#img_id#-img") NEQ 0> checked="checked"</cfif>> 
							<div style="float:right;padding-top:2px;">
								<a href="##" onclick="showwindow('#myself#c.widget_download&file_id=#img_id#&kind=img','#JSStringFormat(myFusebox.getApplicationData().defaults.trans("download"))#',650,1);return false;"><img src="#dynpath#/global/host/dam/images/go-down.png" width="16" height="16" border="0" /></a>
								<cfif cs.show_bottom_part><a href="##" onclick="loadcontent('thedropbasket','#myself#c.basket_put&file_id=#img_id#-img&thetype=#img_id#-img');flash_footer();return false;" title="#myFusebox.getApplicationData().defaults.trans("put_in_basket")#"><img src="#dynpath#/global/host/dam/images/basket-put.png" width="16" height="16" border="0" /></a></cfif>
								<cfif cs.button_send_email>
