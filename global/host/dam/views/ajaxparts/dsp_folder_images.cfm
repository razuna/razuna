					...
					<td>
						<div class="grid-masonry" id="selectme">
							...
							<cfloop query="qry_files">
								...
								<div class="assetbox grid-masonry-item" id="#id#-img#iif(attributes.folder_id NEQ folder_id_r,de('_alias'),de(''))#">
									<cfif is_available>
										...
										<br/><br/>
										<a href="##" onclick="showwindow('#myself##xfa.assetdetail#&file_id=#img_id#&what=images&loaddiv=#kind#&folder_id=#folder_id#&showsubfolders=#attributes.showsubfolders#&row=#mycurrentRow#&filecount=#attributes.qry_filecount#','',1000,1);return false;">
											...
											<cfif attributes.folderaccess NEQ "R">
												<cfif cs.show_trash_icon AND (isadmin OR  cs.show_trash_icon_slct EQ "" OR listfind(cs.show_trash_icon_slct,session.theuserid) OR myFusebox.getApplicationData().global.comparelists(cs.show_trash_icon_slct,session.thegroupofuser) NEQ "")>
													...
													<cfif attributes.folder_id NEQ folder_id_r>
														<a href="##" onclick="showwindow('#myself#ajax.trash_alias&id=#img_id#&loaddiv=img&folder_id=#attributes.folder_id#&showsubfolders=#attributes.showsubfolders#&offset=#session.offset#','#Jsstringformat(myFusebox.getApplicationData().defaults.trans("alias_remove_button"))#',400,1);return false;"><img src="#dynpath#/global/host/dam/images/trash.png" width="16" height="16" border="0" /></a>
													<cfelse>
														<a href="##" onclick="showwindow('#myself#ajax.trash_record&id=#img_id#&what=images&loaddiv=img&folder_id=#attributes.folder_id#&showsubfolders=#attributes.showsubfolders#&offset=#session.offset#','#Jsstringformat(myFusebox.getApplicationData().defaults.trans("trash"))#',400,1);return false;" title="#myFusebox.getApplicationData().defaults.trans("trash")#"><img src="#dynpath#/global/host/dam/images/trash.png" width="16" height="16" border="0" /></a>
													</cfif>
												</cfif>
											</cfif>
										</div>
										...
										<cfif attributes.cs.images_metadata EQ "">
											<a href="##" onclick="showwindow('#myself##xfa.assetdetail#&file_id=#img_id#&what=images&loaddiv=#kind#&folder_id=#folder_id#&showsubfolders=#attributes.showsubfolders#&row=#mycurrentRow#&filecount=#attributes.qry_filecount#','',1000,1);return false;"><strong>#left(img_filename,50)#</strong></a>
										<cfelse>
											<br />
									...
									<cfelse>
										...
										#dateformat(img_create_time, "#myFusebox.getApplicationData().defaults.getdateformat(thestruct=attributes)#")# #timeformat(img_create_time, "HH:mm")#
										<br><br>
					...
					<tr class="thumbview">
						...
						<td valign="top" width="100%">
							...
							<div style="float:left;">
								...
								<select data-placeholder="#myFusebox.getApplicationData().defaults.trans('choose_label')#" class="chzn-select" style="width:410px;" id="tags_img_qe_#img_id#" onchange="razaddlabels('tags_img_qe_#img_id#','#img_id#','img','#myFusebox.getApplicationData().defaults.trans("change_saved")#');" multiple="multiple">
									<option value=""></option>
			...
			<cfelseif session.view EQ "list">
				...
				<cfloop query="qry_files">
					...
					<tr class="list thumbview">
						...
						<td nowrap="true" width="1%" align="center" valign="top">#dateformat(img_create_time, "#myFusebox.getApplicationData().defaults.getdateformat(thestruct=attributes)#")#</td>
						<td nowrap="true" width="1%" align="center" valign="top">#dateformat(img_change_time, "#myFusebox.getApplicationData().defaults.getdateformat(thestruct=attributes)#")#</td>
					</tr>
				</cfloop>
			</cfif>
			<!--- Icon Bar --->
