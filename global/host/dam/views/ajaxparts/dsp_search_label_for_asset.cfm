	...
	<div style="float:left;width:100%;">
		<div style="float:left;text-align:left;padding-left:25px;">
			<cfif qry_labels.recordcount>
				...
				<label style="float:left;width:87%;">
				...
				#label_text# <cfif qry_labels.label_id_r EQ '0'>(root level)<cfelse>(#qry_labels.label_path#)</cfif>
					...
					<!---<label style="float:left;width:87%;">
					<input type="checkbox" name="label_id" class="check" value="#label_id#"  
					data-<cfif qry_labels.label_id_r EQ '0'>#label_text#<cfelse>(#qry_labels.label_path#)</cfif>
					<cfif listfindnocase(attributes.asset_labels_list,#label_id#,',')>checked="checked"</cfif> style="float:left;width:20px; "> 
					#label_text# <cfif qry_labels.label_id_r EQ '0'>(root level)<cfelse>(#qry_labels.label_path#)</cfif>
					</label></br>--->
				</cfloop> 
			<cfelse>
