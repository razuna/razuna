			...
			<tr>
				...
				<td width="65" align="center">
					 ...
					 <cfelse>
					 	...
					 	<a href="#session.thehttp##cgi.http_host##cgi.script_name#?#theaction#=c.si&f=#img_id#&v=o" target="_blank"><img src="#new_cloud_url#" style="max-height:50px;max-width:100px;"></a>
					 </cfif>
				</td>
				<td width="10"></td>
				<td valign="top">
