...
<cfif qry_related.recordcount NEQ 0>
			...
			<tr>
				<td width="55">
					 ...
					 <cfif application.razuna.storage EQ 'local' AND qry_share_options.group_asset_id NEQ ''> 
					 	<a href="#session.thehttp##cgi.http_host##dynpath#/assets/#session.hostid#/#path_to_asset#/thumb_#qry_share_options.group_asset_id#.#qry_settings_image.set2_img_format#" target="_blank">
					 		<img src="#session.thehttp##cgi.http_host##dynpath#/assets/#session.hostid#/#path_to_asset#/thumb_#qry_share_options.group_asset_id#.#qry_settings_image.set2_img_format#" height="50" width="50">
					 	</a>
					 <cfelse>
	...
	<!---<cfloop query="qry_related">
		...
		View
		 ...
		 <cfinvoke component="global.cfc.global" method="get_share_options" thestruct="#args#" returnvariable="qry_share_options">
		 <cfif application.razuna.storage EQ 'local' AND qry_share_options.group_asset_id NEQ ''> 
		 	| <a href="#session.thehttp##cgi.http_host##dynpath#/assets/#session.hostid#/#path_to_asset#/thumb_#qry_share_options.group_asset_id#.#qry_settings_image.set2_img_format#" target="_blank">#myFusebox.getApplicationData().defaults.trans("preview")#</a>
		 <cfelse>
		 	| <a href="#cloud_url#" target="_blank">#myFusebox.getApplicationData().defaults.trans("preview")#</a>
		 </cfif>--->
		 | <a href="##" onclick="showwindow('#myself#c.exist_rendition_images&file_id=#img_id#&img_group_id=#img_group#&thetype=img&cf_show=img&folder_id=#folder_id#&what=#what#','Renditions',875,2);return false;">#myFusebox.getApplicationData().defaults.trans("create_new_renditions")#</a>
		<cfif attributes.folderaccess NEQ "R">
			 | <a href="##" onclick="remren('#img_id#');return false;">#myFusebox.getApplicationData().defaults.trans("delete")#</a>
