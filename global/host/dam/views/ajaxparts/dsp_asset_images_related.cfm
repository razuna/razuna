		...
		<cfloop query="qry_related">
			<tr>
				...
				<td valign="top">
					...
					<button class="awesome small green"><a href="#myself#c.serve_file&file_id=#img_id#&type=img&v=o" style="color:white;text-decoration:none;">#myFusebox.getApplicationData().defaults.trans("download")#</a></button>
