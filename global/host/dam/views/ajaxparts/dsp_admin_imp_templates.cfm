...
<cfoutput>
	<cfif session.hosttype EQ 0>
		#myFusebox.getApplicationData().defaults.trans("admin_import_templates_intro")#<br><br>
		<cfinclude template="dsp_host_upgrade.cfm">
	<cfelse>
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="grid">
			<tr>
				<th colspan="4">
					<div style="float:right;"><a href="##" onclick="showwindow('#myself#c.imp_template_detail&imp_temp_id=0','#myFusebox.getApplicationData().defaults.trans("admin_import_templates_new")#',650,1);">#myFusebox.getApplicationData().defaults.trans("admin_import_templates_new")#</a></div>
				</th>
			</tr>
			<tr>
				<td colspan="4">#myFusebox.getApplicationData().defaults.trans("admin_import_templates_intro")#</td>
			</tr>
		</table>
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="grid">
