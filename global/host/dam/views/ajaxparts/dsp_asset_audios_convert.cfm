					...
					<cfif qry_detail.detail.link_kind NEQ "url">
						...
						<div id="divo#attributes.file_id#" style="display:none;">
							...
							<cfif application.razuna.storage EQ "local">
								<input type="text" id="inputo#attributes.file_id#d" style="width:100%;" value="http://#cgi.http_host##dynpath#/assets/#session.hostid#/#qry_detail.detail.path_to_asset#/#qry_detail.detail.aud_name_org#" />
							<cfelse>
						...
						<div id="dive#attributes.file_id#" style="display:none;">
							<textarea id="inpute#attributes.file_id#" style="width:500px;height:60px;" readonly="readonly"><iframe frameborder="0" src="http://#cgi.http_host##cgi.script_name#?#theaction#=c.sa&f=#attributes.file_id#&v=o" scrolling="auto" width="100%" height="150"></iframe></textarea>
						</div>
					<cfelse>
