						...
						<cfloop query="trash_audios">
							<cfif audgetrash.id EQ trash_audios.name>
								<div class="assetbox">
									...
									<div>
										<a href="##" onclick="showwindow('#myself#ajax.remove_record&id=#audgetrash.id#&what=audios&loaddiv=content&folder_id=#audgetrash.folder_id_r#&showsubfolders=#attributes.showsubfolders#','#Jsstringformat(myFusebox.getApplicationData().defaults.trans("remove"))#',400,1);return false;" title="#myFusebox.getApplicationData().defaults.trans("remove")#">Delete Permanently</a>
									</div>
								</div>
							</cfif> 
						</cfloop>
					...
					<cfloop query="videosgetrash">
						<cfloop query="trash_videos">
							<div class="assetbox">
								...
								<div>
									<a href="##" onclick="showwindow('#myself#ajax.remove_record&id=#videosgetrash.id#&what=videos&loaddiv=content&folder_id=#videosgetrash.folder_id_r#&showsubfolders=#attributes.showsubfolders#','#Jsstringformat(myFusebox.getApplicationData().defaults.trans("remove"))#',400,1);return false;" title="#myFusebox.getApplicationData().defaults.trans("remove")#">Delete Permanently</a>
								</div>
							</div>
						</cfloop>
					</cfloop>
