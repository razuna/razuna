...
<cfoutput>
	...
	<cfif qry_trash.recordcount NEQ 0>
		<div style="float:left;">
			...
			<!--- Restore all file in the trash --->
			<button onclick="showwindow('#myself#c.trash_restore_all&type=restorefileall','#JSStringFormat(myFusebox.getApplicationData().defaults.trans("trash_restoreall"))#',650,1);return false;" class="button">#myFusebox.getApplicationData().defaults.trans("trash_restoreall")#</button>
			<!--- Select All --->
				...
				<tr>
					<td colspan="6" style="border:0px;">
						<div id="folderselectionallform_assets" class="actiondropdown">
							...
							<a href="##" onclick="showwindow('#myself#ajax.remove_record&loaddiv=assets&what=trashfiles&fromtrash=true','#Jsstringformat(myFusebox.getApplicationData().defaults.trans("remove"))#',400,1);return false;" title="#myFusebox.getApplicationData().defaults.trans("remove")#">
								<div style="float:left;">
							...
							<div class="assetbox">
								...
								<div style="float:left;padding-top:5px;">
									<div style="float:left;padding-top:2px;">
										<input type="checkbox" name="file_id" value="#id#-#kind#" onclick="enablesub('allform_assets');"<cfif listfindnocase(session.file_id,"#id#-img") NEQ 0> checked="checked"</cfif>>
									</div>
