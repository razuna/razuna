			...
			<td style="border:0px;" id="selectme">
				<!--- Show trash images --->
					...
					<cfloop query="filetrash">
						<div class="assetbox">
							...
							<div>
								<a href="##" onclick="showwindow('#myself#ajax.remove_record&id=#id#&in_collection=#in_collection#&what=files&loaddiv=assets&folder_id=#folder_id_r#&showsubfolders=#attributes.showsubfolders#&view=combined','#Jsstringformat(myFusebox.getApplicationData().defaults.trans("remove"))#',400,1);return false;" title="#myFusebox.getApplicationData().defaults.trans("remove")#">#myFusebox.getApplicationData().defaults.trans("delete_permanently")#</a>
							</div>
						</div>
					</cfloop>
				...
				<cfloop query="foldertrash">
					<div class="assetbox">
						...
						<div>
							<a href="##" onclick="showwindow('#myself#ajax.remove_folder&folder_id=#folder_id#&in_collection=#in_collection#&what=folder&loaddiv=assets','#Jsstringformat(myFusebox.getApplicationData().defaults.trans("remove_folder"))#',400,1);return false;" title="#myFusebox.getApplicationData().defaults.trans("remove_folder")#">#myFusebox.getApplicationData().defaults.trans("delete_permanently")#</a>
						</div>
					</div>
				</cfloop>
			</td>
