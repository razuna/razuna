...
<table border="0" width="100%" cellspacing="0" cellpadding="0" class="gridno">
	<tr>
		...
		<td align="left" width="1%" nowrap="true">
			<div id="tooltip">
				<cfif !application.razuna.custom.enabled OR (application.razuna.custom.enabled AND application.razuna.custom.icon_select)><a href="##" onClick="CheckAll('#kind#form');" title="#defaultsObj.trans("tooltip_select_desc")#"><img src="#dynpath#/global/host/dam/images/checkbox.png" width="16" name="edit_1" hspace="5" border="0" style="margin-left:0;" /></a></cfif>
				<cfif !application.razuna.custom.enabled OR (application.razuna.custom.enabled AND application.razuna.custom.icon_refresh)><a href="##" onclick="showloadinggif();loadcontent('dummy_#kind#','#myself#c.flushcache');loadcontent('#thediv#','#myself##thefa#&folder_id=#url.folder_id#&kind=#url.kind#');return false;" title="#defaultsObj.trans("tooltip_refresh_desc")#"><img src="#dynpath#/global/host/dam/images/view-refresh-3.png" width="16" height="16" hspace="5" border="0" style="margin-left:7px;" /></a></cfif>
				<cfif !application.razuna.custom.enabled OR (application.razuna.custom.enabled AND application.razuna.custom.icon_show_subfolder)><a href="##" onclick="loadcontent('#thediv#','#myself##thefa#&folder_id=#url.folder_id#&kind=#url.kind#&showsubfolders=<cfif session.showsubfolders EQ "F">T<cfelse>F</cfif>');return false;" title="#defaultsObj.trans("tooltip_subfolders_desc")#"><img src="#dynpath#/global/host/dam/images/link.png" width="16" height="16" hspace="5" border="0" style="margin-left:7px;" /></a></cfif>
				<!--- Add Subfolder ---><cfif session.folderaccess NEQ "R" AND !application.razuna.custom.enabled OR (application.razuna.custom.enabled AND application.razuna.custom.icon_create_subfolder)><a href="##" onclick="showwindow('#myself#c.folder_new&from=list&theid=#url.folder_id#&iscol=F','#defaultsObj.trans("folder_new")#',750,1);return false;" title="#defaultsObj.trans("tooltip_folder_desc")#"><img src="#dynpath#/global/host/dam/images/folder-new-7.png" width="16" height="16" border="0" hspace="5" style="margin-left:7px;"></a></cfif>
				<cfif !application.razuna.custom.enabled OR (application.razuna.custom.enabled AND application.razuna.custom.icon_favorite_folder)><a href="##" onclick="loadcontent('thedropfav','#myself#c.favorites_put&favid=#url.folder_id#&favtype=folder&favkind=');flash_footer();return false;" title="Add this folder to your favorites"><img src="#dynpath#/global/host/dam/images/folder-favorites.png" width="16" height="16" border="0" hspace="5" /></a></cfif>
				<cfif !application.razuna.custom.enabled OR (application.razuna.custom.enabled AND application.razuna.custom.icon_search)><a href="##" onclick="showwindow('#myself#c.search_advanced&folder_id=#attributes.folder_id#','#defaultsObj.trans("folder_search")#',500,1);" title="#defaultsObj.trans("folder_search")#"><img src="#dynpath#/global/host/dam/images/system-search-3.png" width="16" height="16" border="0" hspace="5" /></a></cfif>
				<!--- Exporting icons --->
				<cfif !application.razuna.custom.enabled OR (application.razuna.custom.enabled AND application.razuna.custom.icon_print)>
				...
				<cfif !application.razuna.custom.enabled OR (application.razuna.custom.enabled AND application.razuna.custom.icon_rss)>
				...
				<cfif !application.razuna.custom.enabled OR (application.razuna.custom.enabled AND application.razuna.custom.icon_word)>
				...
				<!--- Import Metadata --->
				<cfif session.folderaccess NEQ "R" AND !application.razuna.custom.enabled OR (application.razuna.custom.enabled AND application.razuna.custom.icon_metadata_import)>
				...
				<!--- Export Metadata --->
				<cfif !application.razuna.custom.enabled OR (application.razuna.custom.enabled AND application.razuna.custom.icon_metadata_export)>
				...
				<!--- Download Folder --->
				<cfif session.folderaccess NEQ "R" AND !application.razuna.custom.enabled OR (application.razuna.custom.enabled AND application.razuna.custom.icon_download_folder)>
		...
		<td width="1%" nowrap="true">
			<div id="folderselection<cfif structkeyexists(attributes,"bot")>b</cfif>#kind#form" style="display:none;">		
				<cfif !application.razuna.custom.enabled OR (application.razuna.custom.enabled AND application.razuna.custom.show_bottom_part)><a href="##" onclick="sendtobasket('#kind#form');">#defaultsObj.trans("put_in_basket")#</a></cfif>
				...
				<select name="fileaction#kind#<cfif structkeyexists(attributes,"bot")>b</cfif>" id="fileaction#kind#<cfif structkeyexists(attributes,"bot")>b</cfif>" onChange="batchaction('#kind#form','<cfif kind EQ "img">images<cfelseif kind EQ "vid">videos<cfelseif kind EQ "aud">audios<cfelseif kind EQ "all">all<cfelse>files</cfif>','#kind#','#attributes.folder_id#','fileaction#kind#<cfif structkeyexists(attributes,"bot")>b</cfif>');" style="width:130px;">
					...
					<cfif !application.razuna.custom.enabled OR (application.razuna.custom.enabled AND application.razuna.custom.tab_collections)><option value="chcoll">#defaultsObj.trans("add_to_collection")#</option></cfif>
