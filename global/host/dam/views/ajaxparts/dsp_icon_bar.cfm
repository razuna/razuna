...
<table border="0" width="100%" cellspacing="0" cellpadding="0" class="gridno">
	<tr>
		...
		<td align="right" width="100%" nowrap="true">
			...
			<cfif attributes.qry_filecount GT session.rowmaxpage>#showoffset# - #shownextrecord#</cfif>
			<cfif attributes.qry_filecount GT session.rowmaxpage AND NOT shownextrecord GTE attributes.qry_filecount> | 
				<!--- For Next --->
				<cfset newoffset = session.offset + 1>
			...
			<cfif attributes.bot eq "true">
				<cfif attributes.qry_filecount GT session.rowmaxpage>
					<span style="padding-left:10px;">
						<cfset thepage = ceiling(attributes.qry_filecount / session.rowmaxpage)>
		...
		<cfif attributes.bot eq "true">
			<td align="right" width="1%" nowrap="true"><cfif attributes.qry_filecount GT session.rowmaxpage OR attributes.qry_filecount GT 25> <select name="selectrowperpage#kind#" id="selectrowperpage#kind#" onChange="changerow('#thediv#','selectrowperpage#kind#')" style="width:80px;">
		...
		<cfelse>
			<td align="right" width="1%" nowrap="true"><cfif attributes.qry_filecount GT session.rowmaxpage OR attributes.qry_filecount GT 25> <select name="selectrowperpage#kind#<cfif structkeyexists(attributes,"bot")>b</cfif>" id="selectrowperpage#kind#<cfif structkeyexists(attributes,"bot")>b</cfif>" onChange="changerow('#thediv#','selectrowperpage#kind#<cfif structkeyexists(attributes,"bot")>b</cfif>')" style="width:80px;">
