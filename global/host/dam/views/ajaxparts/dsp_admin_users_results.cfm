...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="grid">
	...
	<tr>
		...
		<td align="center" valign="top" nowrap width="1%"><a href="##" onclick="showwindow('#myself#ajax.remove_record&what=users&id=#user_id#&loaddiv=uresults','#defaultsObj.trans("remove_selected")#',400,1);return false"><img src="#dynpath#/global/host/dam/images/trash.png" width="16" height="16" border="0"></a></td>
	</tr>
	</cfloop>
</table>
</cfoutput>