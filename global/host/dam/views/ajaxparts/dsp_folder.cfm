	...
	<div id="tabsfolder_tab">
		<ul>
			...
			<cfif attributes.iscol EQ "F">
				<li><a href="##content" onclick="clearMasonry();loadcontent('content','#myself##xfa.fcontent#&folder_id=#attributes.folder_id#&kind=all&iscol=#attributes.iscol#');">#myFusebox.getApplicationData().defaults.trans("folder_content")# (#arraySum(qry_fileTotalAllTypes['cnt'])#)</a></li>
				<cfloop query="qry_fileTotalAllTypes">
					<cfif qry_fileTotalAllTypes.cnt GT 0>
						<cfif ext EQ "img">
							<cfif cs.tab_images>
								<li><a href="##img" onclick="clearMasonry();loadcontent('img','#myself##xfa.fimages#&folder_id=#attributes.folder_id#&kind=img&iscol=#attributes.iscol#');">#myFusebox.getApplicationData().defaults.trans("folder_images")# (#cnt#)</a></li>
							</cfif>
						</cfif>
						<cfif ext EQ "vid">
							<cfif cs.tab_videos>
								<li><a href="##vid" onclick="clearMasonry();loadcontent('vid','#myself##xfa.fvideos#&folder_id=#attributes.folder_id#&kind=vid&iscol=#attributes.iscol#');">#myFusebox.getApplicationData().defaults.trans("folder_videos")# (#cnt#)</a></li>
							</cfif>
						</cfif>
						<cfif ext EQ "aud">
							<cfif cs.tab_audios>
								<li><a href="##aud" onclick="clearMasonry();loadcontent('aud','#myself##xfa.faudios#&folder_id=#attributes.folder_id#&kind=aud&iscol=#attributes.iscol#');">#myFusebox.getApplicationData().defaults.trans("folder_audios")# (#cnt#)</a></li>
							</cfif>
						</cfif>
						<cfif ext EQ "doc">
							<cfif cs.tab_doc>
								<li><a href="##doc" onclick="clearMasonry();loadcontent('doc','#myself##xfa.ffiles#&folder_id=#attributes.folder_id#&kind=doc&iscol=#attributes.iscol#');">#myFusebox.getApplicationData().defaults.trans("folder_word")# (#cnt#)</a></li>
							</cfif>
						</cfif>
						<cfif ext EQ "xls">
							<cfif cs.tab_xls>
								<li><a href="##xls" onclick="clearMasonry();loadcontent('xls','#myself##xfa.ffiles#&folder_id=#attributes.folder_id#&kind=xls&iscol=#attributes.iscol#');">#myFusebox.getApplicationData().defaults.trans("folder_excel")# (#cnt#)</a></li>
							</cfif>
						</cfif>
						<cfif ext EQ "pdf">
							<cfif cs.tab_pdf>
								<li><a href="##pdf" onclick="clearMasonry();loadcontent('pdf','#myself##xfa.ffiles#&folder_id=#attributes.folder_id#&kind=pdf&iscol=#attributes.iscol#');">#myFusebox.getApplicationData().defaults.trans("folder_pdf")# (#cnt#)</a></li>
							</cfif>
						</cfif>
						<cfif ext EQ "other">
							<cfif cs.tab_other>
								<li><a href="##other" onclick="clearMasonry();loadcontent('other','#myself##xfa.ffiles#&folder_id=#attributes.folder_id#&kind=other&iscol=#attributes.iscol#');">#myFusebox.getApplicationData().defaults.trans("folder_others")# (#cnt#)</a></li>
							</cfif>
						</cfif>
					</cfif>
				</cfloop>
