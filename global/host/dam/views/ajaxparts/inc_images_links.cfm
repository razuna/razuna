				...
				<tr>
					<td width="65" align="center">
						...
						<cfelse>
							...
							<cfelse>
								<img src="#thestorage##qry_detail.detail.path_to_asset#/thumb_#attributes.file_id#.#qry_detail.detail.thumb_extension#?_v=#qry_detail.detail.hashtag#" border="0" style="max-height:50px;max-width:100px;">
							</cfif>
						</a>
					</td>
					<td width="10"></td>
					<td>
						...
						<br /> 
						<button type="button" class="awesome small green" onclick="window.open('#myself#c.serve_file&file_id=#attributes.file_id#&type=img&v=p','_blank');">#myFusebox.getApplicationData().defaults.trans("download")#</button>
			...
			<cfif attributes.folderaccess NEQ "R" OR (org_share_setting.recordcount EQ 1 AND org_share_setting.asset_dl EQ 1)>
				<tr>
					...
					<td>
						...
						<br>
						<button type="button" class="awesome small green" onclick="window.open('#myself#c.serve_file&file_id=#attributes.file_id#&type=img&v=o','_blank');">#myFusebox.getApplicationData().defaults.trans("download")#</button>
						<cfif qry_detail.detail.link_kind NEQ "lan">
