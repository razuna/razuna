			...
			<cfif attributes.folderaccess NEQ "R" OR (thumb_share_setting.recordcount EQ 1 AND thumb_share_setting.asset_dl EQ 1)>
				<tr>
					...
					<td>
						...
						<br /> 
						<button class="awesome small green"><a href="#myself#c.serve_file&file_id=#attributes.file_id#&type=img&v=p" style="color:white;text-decoration:none;">#myFusebox.getApplicationData().defaults.trans("download")#</a></button>
			...
			<cfif attributes.folderaccess NEQ "R" OR (org_share_setting.recordcount EQ 1 AND org_share_setting.asset_dl EQ 1)>
				<tr>
					...
					<td>
						...
						<br>
						<button class="awesome small green"><a href="#myself#c.serve_file&file_id=#attributes.file_id#&type=img&v=o" style="color:white;text-decoration:none;">#myFusebox.getApplicationData().defaults.trans("download")#</a></button>
						<cfif qry_detail.detail.link_kind NEQ "lan">
