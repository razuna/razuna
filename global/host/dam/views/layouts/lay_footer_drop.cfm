...
<cfif cs.show_basket_part OR cs.show_favorites_part OR qry_orders.recordcount NEQ 0>	
	...
	<div id="tabs_footer">
		<ul>
			<li style="#basket_css#" ><a href="##thedropbasket" id="div_link_basket" onclick="tooglefooter('0');loadcontent('thedropbasket','#myself#c.basket');">Show #myFusebox.getApplicationData().defaults.trans("header_basket")#</a></li>
