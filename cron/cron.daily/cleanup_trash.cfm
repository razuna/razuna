...
<cftry>
	...
	<cfloop query="_hosts">
		...
		<!--- Get host settings --->
		<cfquery datasource="#_struct.razuna.application.datasource#" name="qry_host_settings">
		...
		<!--- Images --->
		<cfquery datasource="#_struct.razuna.application.datasource#" name="qry_img">
		...
		<cfif qry_img.recordcount>
			...
			<cfset _deleteImages( file_qry=qry_img, prefix=host_shard_group, host_id=host_id, host_settings=qry_host_settings, thestruct=_struct )>
		</cfif>

		<!--- Videos --->
		<cfquery datasource="#_struct.razuna.application.datasource#" name="qry_vid">
		...
		<!--- Audios --->
		<cfquery datasource="#_struct.razuna.application.datasource#" name="qry_aud">
		...
		<!--- Files --->
		<cfquery datasource="#_struct.razuna.application.datasource#" name="qry_doc">
		...
		<cfinvoke component="global.cfc.global" method="resetCacheExternal" type="search" thestruct="#_struct#" />
		<cfinvoke component="global.cfc.global" method="resetCacheExternal" type="folders" thestruct="#_struct#" />
	...
	<cffunction name="_deleteImages">
		...
		<cfloop query="arguments.file_qry">
			...
			<cfset _deleteFile(file_data=s, prefix=arguments.prefix, host_id=arguments.host_id, host_settings=arguments.host_settings, category="img", thestruct=arguments.thestruct)>
		</cfloop>
		<!--- Reset cache --->
		<cfinvoke component="global.cfc.global" method="resetCacheExternal" type="images" thestruct="#arguments.thestruct#" />
	</cffunction>
	...
	<cffunction name="_deleteVideos">
		...
		<!--- Reset cache --->
		<cfinvoke component="global.cfc.global" method="resetCacheExternal" type="videos" thestruct="#arguments.thestruct#/>
	</cffunction>
	...
	<cffunction name="_deleteAudios">
		...
		<!--- Reset cache --->
		<cfinvoke component="global.cfc.global" method="resetCacheExternal" type="audios" thestruct="#arguments.thestruct#" />
	</cffunction>
	...
	<cffunction name="_deleteDocs">
		...
		<!--- Reset cache --->
		<cfinvoke component="global.cfc.global" method="resetCacheExternal" type="files" thestruct="#arguments.thestruct#" />
	</cffunction>
